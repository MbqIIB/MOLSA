...
public class MOLSAFamilyOfPrisonerEligibilityCalculatorTest extends
	 ...
	 * FamilyOfPrisonerEligibilityUnitCalculator
	 */
	...
	public void testhasHouseholdPassedIncomeTestTimeline() {
		...
		familyOfPrisonerObj.totalCountableIncomeTimeline().specifyValue(
				amountTimeline);
		familyOfPrisonerObj.primaryBeneficiaryAmount().specifyValue(
				amount2Timeline);
		CREOLETestHelper.assertEquals(resultTimeline, familyOfPrisonerObj
	...
	public void testtotalCountableIncomeTimeline() {
		...
		familyOfPrisonerObj.totalExpenseAmountTimeline().specifyValue(
				amount2Timeline);
		CREOLETestHelper.assertEquals(amount3Timeline, familyOfPrisonerObj
	 ...
	 * records Test Class : FamilyOfPrisonerEligibilityUnitCalculator
	 */
	...
	public void testTotalExpenseAmountTimeline() {
		...
		familyOfPrisonerObj.caseID().specifyValue(
				caseParticipantRoleList.get(0).caseID().getValue());

		CREOLETestHelper.assertEquals(amountTimeline, familyOfPrisonerObj
	...
	public void testMonthlyAmountTimeline() {
		...
		familyOfPrisonerObj.totalCountableIncomeTimeline().specifyValue(
				amountTimeline);
		CREOLETestHelper.assertEquals(outputTimeline, familyOfPrisonerObj
	 ...
	 * married Test Class : FamilyOfPrisonerCPRCalculator
	 */
	...
	public void testisMarriedTimeline() {
		...
		CREOLETestHelper
				.assertEquals(Timeline.TRUE_FOREVER,
						familyOfPrisonerCPRCalculatorObj.isMarriedTimeline()
								.getValue());
	}
	...
	public void testisMarriedTimeline1() {
		...
		CREOLETestHelper
				.assertEquals(Timeline.FALSE_FOREVER,
						familyOfPrisonerCPRCalculatorObj.isMarriedTimeline()
								.getValue());
	}
	 ...
	 * female/male and tested Test Class : FamilyOfPrisonerCPRCalculator
	 */
	...
	public void testisEligibleWifeTimeline() {
		...
		familyOfPrisonerCPRCalculatorObj.caseParticipantRoleRecord()
				.specifyValue(caseParticipantRoleList.get(0));
		familyOfPrisonerCPRCalculatorObj.isFemaleTimeline().specifyValue(
				Timeline.TRUE_FOREVER);
		familyOfPrisonerCPRCalculatorObj.isMarriedTimeline().specifyValue(
				Timeline.TRUE_FOREVER);
		familyOfPrisonerCPRCalculatorObj.isAgeBelowSixtyTimeline()
				.specifyValue(Timeline.TRUE_FOREVER);
		familyOfPrisonerCPRCalculatorObj.memberCPRCalculator().specifyValue(
		...
		CREOLETestHelper.assertEquals(Timeline.TRUE_FOREVER,
				familyOfPrisonerCPRCalculatorObj.isEligibleWifeTimeline()
						.getValue());
	}
