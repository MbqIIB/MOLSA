...
public class MOLSAIncapableOfWorkingEligibilityUnitCalculatorTest extends
	 ...
	 * IncapableOfWorkingEligibilityUnitCalculator
	 */
	...
	public void testhasHouseholdPassedIncomeTestTimeline() {
		...
		incapableOfWorkingObj.totalCountableIncomeTimeline().specifyValue(
				amountTimeline);
		incapableOfWorkingObj.primaryBeneficiaryAmount().specifyValue(
				amount2Timeline);
		CREOLETestHelper.assertEquals(resultTimeline, incapableOfWorkingObj
	...
	public void testtotalCountableIncomeTimeline() {
		...
		final IncapableOfWorkingEligibilityUnitCalculator incapableOfWorkingObj = IncapableOfWorkingEligibilityUnitCalculator_Factory
				.getFactory().newInstance(getSession(), caseID,
						saHouseholdUnitCalculator);
		incapableOfWorkingObj.caseID().specifyValue(caseID);
		incapableOfWorkingObj.unearnedIncomeAmount().specifyValue(
				amountTimeline);
		incapableOfWorkingObj.totalExpenseAmountTimeline().specifyValue(
				amount2Timeline);
		CREOLETestHelper.assertEquals(amount3Timeline, incapableOfWorkingObj
	 ...
	 * records Test Class : IncapableOfWorkingEligibilityUnitCalculator
	 */
	...
	public void testTotalExpenseAmountTimeline1() {
		...
		incapableOfWorkingObj.caseID().specifyValue(
				caseParticipantRoleList.get(0).caseID().getValue());

		CREOLETestHelper.assertEquals(amountTimeline, incapableOfWorkingObj
	...
	public void testMonthlyAmountTimeline() {
		...
		incapableOfWorkingObj.totalCountableIncomeTimeline().specifyValue(
				amountTimeline);
		CREOLETestHelper.assertEquals(outputTimeline, incapableOfWorkingObj
	 ...
	 * married Test Class : IncapableOfWorkingCPRCalculator
	 */
	...
	public void testisMarriedTimeline() {
		...
		CREOLETestHelper.assertEquals(Timeline.TRUE_FOREVER,
				incapableOfWorkingCPRCalculatorObj.isMarriedTimeline()
						.getValue());
	}
	...
	public void testisMarriedTimeline2() {
		final long caseParticipantRoleID = 11L;
		final long participantRoleID = 111L;
		final long caseID = 111L;
		final String Name = "Pavan";
	...
	public void testisMarriedTimeline3() {
		final long caseParticipantRoleID = 11L;
		final long participantRoleID = 111L;
		final long caseID = 111L;
		final String Name = "Pavan";
