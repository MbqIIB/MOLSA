    ...
    <fo:root>
      ...
      <fo:page-sequence master-reference="only">
        ...
        <fo:flow flow-name="xsl-region-body" font-family="WT Sans ME">
          ...
          <fo:block xsl:use-attribute-sets="Normal_3"> </fo:block>
          <fo:block xsl:use-attribute-sets="Normal_6">
            هذا العقد يعد اتفاقية بين العميل
            <xsl:apply-templates select="FIELD[FNAME='concernRoleName']" />
            و
            <xsl:apply-templates select="FIELD[FNAME='organisationName']" />.
            وقد وافق العميل على تنفيذ المهام التالية وبالتالي
            للاعانات بموجب الحالة المتكاملة له/لها بكود التعريف
            ...
            <fo:table-body>
              <fo:table-row line-height="5mm">
                <fo:table-cell column-number="1">
                  <fo:block xsl:use-attribute-sets="Normal_7">كود تعريف المهمة</fo:block>
                </fo:table-cell>
                <fo:table-cell column-number="2">
                  <fo:block xsl:use-attribute-sets="Normal_8">وصف المهمة</fo:block>
                </fo:table-cell>
                <fo:table-cell column-number="3">
                  <fo:block xsl:use-attribute-sets="Normal_8">تاريخ الاستحقاق</fo:block>
                </fo:table-cell>
              </fo:table-row>
