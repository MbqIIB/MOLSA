              ...
              <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                <fo:block text-align="justify">
                  ...
                  <fo:inline font-size="12pt">
                    نود احاطتكم بأن تاريخ استحقاق احالة اللائحة للفترة من <xsl:apply-templates select="FIELD[FNAME='fromDate']" />
                    الى <xsl:apply-templates select="FIELD[FNAME='toDate']" />
                    هي <xsl:apply-templates select="FIELD[FNAME='submissionDueDate']" />
                    .
                  </fo:inline>
                  <fo:block>
                    <fo:leader leader-pattern="space" />
