              ...
              <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                <fo:block text-align="justify">
                  ...
                  <fo:inline font-size="12pt">
                    نود اعلامك بأنه قد تم تعليقك كجهة تقديم لهيئتنا
 بموجب رقم المرجع، <xsl:apply-templates select="FIELD[FNAME='providerRefNumber']" /> وقد تم تعليقك للسبب التالي: <xsl:apply-templates select="FIELD[FNAME='reason']" />.
                  </fo:inline>
                  <fo:block>
                    <fo:leader leader-pattern="space" />
                  </fo:block>
