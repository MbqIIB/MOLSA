              ...
              <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                <fo:block text-align="justify">
                  ...
                  <fo:inline font-size="12pt">
                    نريد اعلامك بأن الترخيص الخاص بك يستحق الانتهاء في <xsl:apply-templates select="FIELD[FNAME='expirationDate']" />. برجاء
ارسال المطبوعات الفنية المتعلقة بالترخيص الخاص بك ليتم تجديدها.
                  </fo:inline>
                  <fo:block>
                    <fo:leader leader-pattern="space" />
                  </fo:block>
