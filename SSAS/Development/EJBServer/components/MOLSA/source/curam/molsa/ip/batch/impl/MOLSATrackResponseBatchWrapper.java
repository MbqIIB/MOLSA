 ...
 * 
 */
public class MOLSATrackResponseBatchWrapper implements BatchMain {

	private curam.molsa.ip.batch.intf.MOLSATrackResponseBatch molsaTrackResponseBatch;

	/**
	 * This is a constructor for the wrapper class
	 * 
	 * @param molsaTrackResponseBatch
	 *            MOLSATrackResponseBatch
	 */
	public MOLSATrackResponseBatchWrapper(
			MOLSATrackResponseBatch molsaTrackResponseBatch) {
		this.molsaTrackResponseBatch = molsaTrackResponseBatch;
	}
	...
	public void sendBatchReport(String instanceID,
		...
		this.molsaTrackResponseBatch.sendBatchReport(instanceID,
