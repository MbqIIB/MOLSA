...
public class MOLSABulkPDCGeneratorBatchWrapper implements BatchMain {
   ...
   * 
   * @param molsaBulkPDCGeneratorBatch2
   *          MOLSABulkPDCGeneratorBatch
   */
  ...
  public void sendBatchReport(String instanceID, BatchProcessDtls batchProcessDtls, BatchProcessChunkDtlsList processedBatchProcessChunkDtlsList,
    ...
    this.molsaBulkPDCGeneratorBatch.sendBatchReport(instanceID, batchProcessDtls, processedBatchProcessChunkDtlsList, unprocessedBatchProcessChunkDtlsList);
  }
