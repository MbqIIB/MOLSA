package curam.molsa.test.eligibility.familyofprisoner;
...
import curam.creole.ruleclass.FamilyOfMissingEligibilityAndEntitlementRuleSet.impl.AmountCalculator;
import curam.creole.ruleclass.FamilyOfMissingEligibilityAndEntitlementRuleSet.impl.AmountCalculator_Factory;
...
import curam.creole.ruleclass.FamilyOfPrisonerEligibilityAndEntitlementRuleSet.impl.FamilyOfPrisonerCPRCalculator;
import curam.creole.ruleclass.FamilyOfPrisonerEligibilityAndEntitlementRuleSet.impl.FamilyOfPrisonerCPRCalculator_Factory;
import curam.creole.ruleclass.FamilyOfPrisonerEligibilityAndEntitlementRuleSet.impl.FamilyOfPrisonerEligibilityUnitCalculator;
import curam.creole.ruleclass.FamilyOfPrisonerEligibilityAndEntitlementRuleSet.impl.FamilyOfPrisonerEligibilityUnitCalculator_Factory;
...
/**
 * Junit class for MOLSA FamilyOfPrisonerEligibilityAndEntitlementRuleSet
 * 
 * 
 */
@SuppressWarnings("restriction")
public class MOLSAFamilyOfPrisonerEligibilityCalculatorTest extends
MOLSACreoleBaseTest {

	public static final String MOLSA_RULESET = "FamilyOfPrisonerEligibilityAndEntitlementRuleSet";
	 ...
	 *            default argument
	 */
	public MOLSAFamilyOfPrisonerEligibilityCalculatorTest(String arg0) {
		super(arg0);
		setRuleSetName();
	}
	...
	/**
	   ...
	   * Test Class : FamilyOfPrisonerEligibilityUnitCalculator
	   */
	...
	public void testUnearnedIncomeAmount(){
		...
		final FamilyOfPrisonerEligibilityUnitCalculator familyOfPrisonerObj = FamilyOfPrisonerEligibilityUnitCalculator_Factory
		...
		familyOfPrisonerObj.caseID().specifyValue(caseParticipantRoleList.get(0).caseID().getValue());
		
		CREOLETestHelper.assertEquals(amountTimeline,
				familyOfPrisonerObj.unearnedIncomeAmount().getValue());
	}
	...
	public void testhasHouseholdPassedIncomeTestTimeline(){
		...
		.getFactory().newInstance(getSession(), caseID,
				saHouseholdUnitCalculator);
		familyOfPrisonerObj.caseID().specifyValue(caseID);
		familyOfPrisonerObj.totalCountableIncomeTimeline().specifyValue(amountTimeline);
		familyOfPrisonerObj.primaryBeneficiaryAmount().specifyValue(amount2Timeline);
		CREOLETestHelper.assertEquals(resultTimeline,
				familyOfPrisonerObj.hasHouseholdPassedIncomeTestTimeline().getValue());
	}
	...
	public void testtotalCountableIncomeTimeline(){
		...
		.getFactory().newInstance(getSession(), caseID,
				saHouseholdUnitCalculator);
		familyOfPrisonerObj.caseID().specifyValue(caseID);
		familyOfPrisonerObj.unearnedIncomeAmount().specifyValue(amountTimeline);
		familyOfPrisonerObj.totalExpenseAmountTimeline().specifyValue(amount2Timeline);
		CREOLETestHelper.assertEquals(amount3Timeline,
				familyOfPrisonerObj.totalCountableIncomeTimeline().getValue());
	}
	...
	public void testTotalExpenseAmountTimeline(){
		...
		CREOLETestHelper.assertEquals(amountTimeline,
				familyOfPrisonerObj.totalExpenseAmountTimeline().getValue());
	}
	...
	public void testMonthlyAmountTimeline(){
		...
		familyOfPrisonerObj.totalCountableIncomeTimeline()
				.specifyValue(amountTimeline);
		CREOLETestHelper.assertEquals(outputTimeline,
				familyOfPrisonerObj.monthlyAmountTimeline().getValue());
	}
	...
	public void testPrimaryBeneficiaryAmount(){
		...
		saHouseholdUnitCalculator.mandatoryMembers().specifyValue(
				saHouseholdUnitMemberList);
		final AmountCalculator acObj = AmountCalculator_Factory.getFactory().newInstance(getSession(), caseParticipantRoleList.get(0));
		acObj.caseParticipantRoleRecord().specifyValue(caseParticipantRoleList.get(0));
		
		
		final List<Interval<Number>> amount = new ArrayList<Interval<Number>>();
		amount.add(new Interval<Number>(null, 3000));
		amount.add(new Interval<Number>(Date.fromISO8601("20040601"), 3000));
		final Timeline<Number> amountTimeline = new Timeline<Number>(amount);
		...
		.getFactory().newInstance(getSession(), caseID,
				saHouseholdUnitCalculator);
		familyOfPrisonerObj.caseID().specifyValue(caseID);
		familyOfPrisonerObj.eligibilityUnitMembers().specifyValue(caseParticipantRoleList);
		
		CREOLETestHelper.assertEquals(amountTimeline,
				familyOfPrisonerObj.primaryBeneficiaryAmount().getValue());
		
	}
	
	 /**
	   * Test case for 'isMarriedTimeline' attribute. 
	   * Test Data: Marital status as married
	   * Test Class : FamilyOfPrisonerCPRCalculator
	   */
	...
	public void testisMarriedTimeline(){
		...
		final FamilyOfPrisonerCPRCalculator familyOfPrisonerCPRCalculatorObj = FamilyOfPrisonerCPRCalculator_Factory
		...
		CREOLETestHelper.assertEquals(Timeline.TRUE_FOREVER,
				familyOfPrisonerCPRCalculatorObj.isMarriedTimeline().getValue());
	}
	...
	public void testisFemaleTimeline(){
		...
		CREOLETestHelper.assertEquals(Timeline.TRUE_FOREVER,
				familyOfPrisonerCPRCalculatorObj.isFemaleTimeline().getValue());
	}
	...
	public void testisEligibleWifeTimeline(){
		...
		familyOfPrisonerCPRCalculatorObj.caseParticipantRoleRecord().specifyValue(caseParticipantRoleList.get(0));
		familyOfPrisonerCPRCalculatorObj.isFemaleTimeline().specifyValue(Timeline.TRUE_FOREVER);
		familyOfPrisonerCPRCalculatorObj.isMarriedTimeline().specifyValue(Timeline.TRUE_FOREVER);
		familyOfPrisonerCPRCalculatorObj.memberCPRCalculator().specifyValue(memberCPRCalculatorobj);
      ...
      final List<Interval<CodeTableItem>> test11 = new ArrayList<Interval<CodeTableItem>>();
		test11.add(new Interval<CodeTableItem>(null, new CodeTableItem(RESIDENCY.TABLENAME, RESIDENCY.YES)));
      ...
      final SANonFinancialCPRCalculator testObj = SANonFinancialCPRCalculator_Factory.getFactory().newInstance(getSession(), caseParticipantRoleList.get(0));
      ...
      CREOLETestHelper.assertEquals(Timeline.TRUE_FOREVER,
    		  familyOfPrisonerCPRCalculatorObj.isEligibleWifeTimeline().getValue());
	}
	...
	public void testisEligibleWifeTimeline1(){
		...
		familyOfPrisonerCPRCalculatorObj.caseParticipantRoleRecord().specifyValue(caseParticipantRoleList.get(0));
		familyOfPrisonerCPRCalculatorObj.isFemaleTimeline().specifyValue(Timeline.FALSE_FOREVER);
		familyOfPrisonerCPRCalculatorObj.isMarriedTimeline().specifyValue(Timeline.TRUE_FOREVER);
		familyOfPrisonerCPRCalculatorObj.memberCPRCalculator().specifyValue(memberCPRCalculatorobj);
