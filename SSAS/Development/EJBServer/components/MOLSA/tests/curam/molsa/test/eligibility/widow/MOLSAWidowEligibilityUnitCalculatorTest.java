...
public class MOLSAWidowEligibilityUnitCalculatorTest extends MOLSACreoleBaseTest{
	...
	public void testIsWidowTimeline(){
		...
		widowCPRCalculatorObj.isFemaleTimeline().specifyValue(Timeline.TRUE_FOREVER);
		widowCPRCalculatorObj.isAgeBelowSixtyTimeline().specifyValue(Timeline.TRUE_FOREVER);
	...
	public void testIsWidowTimeline1(){
		...
		widowCPRCalculatorObj.isWidow().specifyValue(Timeline.TRUE_FOREVER);
		widowCPRCalculatorObj.isFemaleTimeline().specifyValue(Timeline.FALSE_FOREVER);
		widowCPRCalculatorObj.isAgeBelowSixtyTimeline().specifyValue(Timeline.TRUE_FOREVER);
	  ...
	  /**
	   * Test case for 'IsWidow' attribute. 
	   * Test Data:Marital status specified as Widowed and tested
	   * Test Class : WidowCPRCalculator
	   */
	...
	public void testIsWidow(){
		...
		final List<Interval<CodeTableItem>> test1 = new ArrayList<Interval<CodeTableItem>>();
		test1.add(new Interval<CodeTableItem>(null, new CodeTableItem(MARITALSTATUS.TABLENAME, MARITALSTATUS.WIDOWED)));
	...
	public void testIsAgeBelowSixtyTimeline() {
		...
		intervals.add(new Interval<Boolean>(Date.fromISO8601("20520711"), false));
		...
		CREOLETestHelper.assertEquals(expectedTimeline, widowCPRCalculatorObj.isAgeBelowSixtyTimeline()
				.getValue());
	}
	
	public void testIsAgeBelowSixtyTimeline1() {
		final long caseParticipantRoleID = 11L;
		final long participantRoleID = 111L;
		final long caseID = 111L;
		final String Name = "Test";
		...
		intervals.add(new Interval<Boolean>(null, true));
		intervals
				.add(new Interval<Boolean>(Date.fromISO8601("19600614"), true));
		intervals
		.add(new Interval<Boolean>(Date.fromISO8601("19600615"), false));
		final Timeline<Boolean> expectedTimeline = new Timeline<Boolean>(
				intervals);
		...
		CREOLETestHelper.assertEquals(expectedTimeline, widowCPRCalculatorObj
				.isAgeBelowSixtyTimeline().getValue());
	}
	
	/**
	   * Test case for 'IsEligible' attribute. 
	   * Test Data:
	   */
	...
	public void testUnearnedIncomeAmount(){
		...
		CREOLETestHelper.assertEquals(amountTimeline,
				widowedEligibilityUnitCalculatorObj.unearnedIncomeAmount().getValue());
	}
	...
	public void testTotalExpenseAmountTimeline(){
		...
		CREOLETestHelper.assertEquals(amountTimeline,
				widowedEligibilityUnitCalculatorObj.totalExpenseAmountTimeline().getValue());
	}
	...
	public void testTotalCountableIncomeTimeline(){
      ...
      // When unearned income is greater than total expense amount
		...
		widowedEligibilityUnitCalculatorObj.totalExpenseAmountTimeline().specifyValue(amount2Timeline);
		...
		CREOLETestHelper.assertEquals(outputTimeline,
				widowedEligibilityUnitCalculatorObj.totalCountableIncomeTimeline().getValue());
	}
	...
	public void testMonthlyAmountTimeline(){
		...
		widowedEligibilityUnitCalculatorObj.totalCountableIncomeTimeline()
				.specifyValue(amountTimeline);
		CREOLETestHelper.assertEquals(outputTimeline,
				widowedEligibilityUnitCalculatorObj.monthlyAmountTimeline().getValue());
	}
	...
	public void testMonthlyAmountTimeline1(){
     ...
     public void testHouseholdUnit() {
			...
			WidowHouseholdComposition householdComposition = WidowHouseholdComposition_Factory
			.getFactory().newInstance(getSession());
