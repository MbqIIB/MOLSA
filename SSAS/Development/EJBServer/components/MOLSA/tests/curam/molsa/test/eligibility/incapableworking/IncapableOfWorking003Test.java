...
public class IncapableOfWorking003Test extends CERScenarioTestBase {
	...
	public IncapableOfWorking003Test(String arg0) {
		super(arg0);
	...
	protected void addEvidence(CaseKey caseKey) throws AppException,
		...
		// TODO Auto-generated method stub
		long participantid = getParticipantRoleID(RAFI_UNIQUE_NAME).participantRoleID;
		long caseParticipantRoleID = getCaseParticipantRoleID(RAFI_UNIQUE_NAME).caseParticipantRoleID;
		
		
		int incomeamount=5000;
	...
	protected void setClaimantRegistrationDetails(
		...
		customerRegistrationDetails.firstForename = RAFI_UNIQUE_NAME;
	...
	/**
	  ...
	  protected void performCOC(final CaseKey caseKey) throws AppException, InformationalException {
	    ...
	    long participantid = getParticipantRoleID(RAFI_UNIQUE_NAME).participantRoleID;
	    long casePartcipantRoleID = getCaseParticipantRoleID(RAFI_UNIQUE_NAME).caseParticipantRoleID;
