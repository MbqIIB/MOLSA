...
public class FamilyInNeed002Test extends CERScenarioTestBase {
	...
	public FamilyInNeed002Test(String arg0) {
		super(arg0);
	...
	protected void addEvidence(CaseKey caseKey) throws AppException,
		...
		long wife2participantid= getParticipantRoleID(FATHIMA_UNIQUE_NAME).participantRoleID;
		long wife2caseParticipantRoleID=getCaseParticipantRoleID(FATHIMA_UNIQUE_NAME).caseParticipantRoleID;
		...
		createBirthAndDeathEvidence(caseKey, wife1participantid,
				wife1caseParticipantRoleID, currentDate, getDate(1, 1, 1980));
		createBirthAndDeathEvidence(caseKey, wife2participantid,
				wife2caseParticipantRoleID, currentDate, getDate(1, 1, 1984));
		...
		createGenderEvidence(caseKey,
				wife1participantid,wife2caseParticipantRoleID,
				currentDate,GENDER.FEMALE);
		createGenderEvidence(caseKey,
		...
		createHouseholdRelationshipEvidence(caseKey,
				participantid,caseParticipantRoleID,wife1caseParticipantRoleID, getDate(1, 1, 1995)
				,RELATIONSHIPTYPECODE.SPOUSE);
		createHouseholdRelationshipEvidence(caseKey,
				participantid,caseParticipantRoleID,wife2caseParticipantRoleID,
		...
		createHouseholdRelationshipEvidence(caseKey,
				wife1participantid,wife1caseParticipantRoleID,wife2caseParticipantRoleID,
				 getDate(1, 1, 2000),RELATIONSHIPTYPECODE.SISTERWIFE);
	...
	protected void addCaseMember(Application application) throws AppException,
		...
		PersonRegistrationDetails registrationIDDetails = new  PersonRegistrationDetails();
          ...
          registrationIDDetails1.surname = MOHAMMED_SURNAME;
	...
	/**
	  ...
	  protected void performCOC(final CaseKey caseKey) throws AppException, InformationalException {
	    ...
	    createHouseholdMemberEvidence(caseKey, participantid, casePartcipantRoleID, currentDate, CITIZENSHIPCODE.NOT_A_QATARI, RESIDENCY.YES);
	    deleteEvidence(caseKey, wife2caseParticipantRoleID, "DET0000514");
	    addVerifications(caseKey);
	...
	protected void postAssertionOnCase(CaseKey caseKey) throws AppException,
			InformationalException {
		//CaseDetermination caseDetermination = CaseDeterminationFactory.newInstance().listDecisionPeriodsForDetermination(null).
