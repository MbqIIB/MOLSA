...
public class Orphan004Test extends CERScenarioTestBase {
	...
	public Orphan004Test(String arg0) {
		super(arg0);
	...
	/**
	  ...
	  protected void performCOC(final CaseKey caseKey) throws AppException, InformationalException {
	    ...
	    createIncomeEvidence(caseKey,participantid,
				...
				INCOMETYPECODE.OtherHouseholdPaidEmployment,FREQUENCYCODE.MONTHLY,3000);
		
	    createIncomeEvidence(caseKey,participantid,
	    		casePartcipantRoleID,getDate(1, 1, 2013),
				INCOMETYPECODE.INHERITANCE,FREQUENCYCODE.MONTHLY,8000);
