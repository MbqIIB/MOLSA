...
public class Widow002Test extends CERScenarioTestBase {
	...
	public Widow002Test(String arg0) {
		super(arg0);
	...
	protected void addEvidence(CaseKey caseKey) throws AppException,
		...
		createBirthAndDeathEvidence(caseKey, sisterwifeparticipantid,
				sisterwifecaseParticipantRoleID, currentDate, getDate(1, 1, 1975));
		
		createMaritalStatusEvidence(caseKey, participantid,
				caseParticipantRoleID, currentDate, MARITALSTATUS.WIDOWED);
		createMaritalStatusEvidence(caseKey, sisterwifeparticipantid,
				sisterwifecaseParticipantRoleID, currentDate, MARITALSTATUS.WIDOWED);
		...
		createIncomeEvidence(caseKey, participantid,
				...
				INCOMETYPECODE.FatherORHusbandPaidEmployment,FREQUENCYCODE.MONTHLY,amount);
		...
		createIncomeEvidence(caseKey, sisterwifeparticipantid,
				sisterwifecaseParticipantRoleID,getDate(1, 1, 2013),
				INCOMETYPECODE.INHERITANCE,FREQUENCYCODE.MONTHLY,amount1);
	...
	protected void addCaseMember(Application application) throws AppException,
		...
		PersonRegistrationDetails registrationIDDetails = new  PersonRegistrationDetails();
          registrationIDDetails.currentMaritalStatus = MARITALSTATUS.WIDOWED;
