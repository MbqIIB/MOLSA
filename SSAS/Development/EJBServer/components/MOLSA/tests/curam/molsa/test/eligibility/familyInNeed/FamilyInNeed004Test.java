...
public class FamilyInNeed004Test extends CERScenarioTestBase {
	...
	public FamilyInNeed004Test(String arg0) {
		super(arg0);
	...
	/**
	  ...
	  protected void performCOC(final CaseKey caseKey) throws AppException, InformationalException {
	   ...
	   /* createIncomeEvidence(caseKey, participantid,
				...
				INCOMETYPECODE.INHERITANCE,FREQUENCYCODE.MONTHLY,incomeamount2);*/
	    addVerifications(caseKey);
