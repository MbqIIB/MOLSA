...
public class FamilyInNeed001Test extends CERScenarioTestBase {
	...
	public FamilyInNeed001Test(String arg0) {
		super(arg0);
	...
	protected void addEvidence(CaseKey caseKey) throws AppException,
		...
		createIncomeEvidence(caseKey, wife2participantid,
				...
				FREQUENCYCODE.MONTHLY,INCOMETYPECODE.FatherORHusbandPaidEmployment,incomeamount1);
