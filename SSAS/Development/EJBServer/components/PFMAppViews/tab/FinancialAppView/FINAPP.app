...
<ac:application xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
 ...
 id="FINAPP"
 logo="FinancialApp.logo"
 title="FinancialApp.title"
 subtitle="FinancialApp.subtitle"
 user-message="FinancialApp.UserMessage">
  ...
  <ac:section-ref id="FINAPPHomeSection"/>
  <ac:section-ref id="FINAPPSection"/>
