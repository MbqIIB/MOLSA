...
<ac:application xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
 ...
 id="INVESTRAPP"
 logo="INVESTRAPP.logo"
 title="INVESTRAPP.title"
 subtitle="INVESTRAPP.subtitle"
 user-message="INVESTRAPP.UserMessage">
  ...
  <ac:section-ref id="INVESTRAPPHomeSection"/>
  <ac:section-ref id="INVESTRAPPSection"/>
