...
<ac:application xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
 ...
 id="AUDITCOAPP"
 logo="AuditCoordinatorApp.logo"
 title="AuditCoordinatorApp.title"
 subtitle="AuditCoordinatorApp.subtitle"
 user-message="AuditCoordinatorApp.UserMessage">
  ...
  <ac:section-ref id="AUDITCOAPPHomeSection"/>
  <ac:section-ref id="AUDITCOAPPSection"/>
