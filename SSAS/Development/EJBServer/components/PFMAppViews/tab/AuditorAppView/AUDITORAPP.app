...
<ac:application xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
 ...
 id="AUDITORAPP"
 logo="AuditorApp.logo"
 title="AuditorApp.title"
 subtitle="AuditorApp.subtitle"
 user-message="AuditorApp.UserMessage">
  ...
  <ac:section-ref id="AUDITORAPPHomeSection"/>
  <ac:section-ref id="AUDITORAPPSection"/>
