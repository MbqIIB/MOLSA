						...
						<!-- BEGIN, CR00356535, PB -->
                            ...
                            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                <fo:block text-align="justify">
                                    ...
                                    <fo:inline font-size="12pt"><xsl:apply-templates select="FIELD[FNAME='providerGroupName']"/> agrees that the following providers will
                                        deliver the services listed below at the following rate from <xsl:apply-templates select="FIELD[FNAME='startDate']"/> to 
    ...
    <xsl:template name="ServiceRates">      
        <fo:table margin-left="0.0pt" border-collapse="collapse">
            ...
            <fo:table-body margin-left="0.0pt">
                <fo:table-row margin-left="0.0pt">test
