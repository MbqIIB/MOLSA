              ...
              <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                <fo:block text-align="justify">
                  ...
                  <fo:inline font-size="12pt" font-weight="normal">Dear <xsl:apply-templates
                    select="FIELD[FNAME='providerName']"/>,
                  </fo:inline>
                  <fo:block>
                    <fo:leader leader-pattern="space"/>
                  </fo:block>
                  ...
                  <fo:inline font-size="12pt"> This contract is an agreement between 
                    <xsl:apply-templates select="FIELD[FNAME='providerName']"/> and 
                    <xsl:apply-templates select="FIELD[FNAME='organizationName']"/>. </fo:inline>
                  <fo:block>
                    <fo:leader leader-pattern="space"/>
                  </fo:block>
                  <fo:inline font-size="12pt"><xsl:apply-templates select="FIELD[FNAME='providerName']"/> agrees to deliver the services
                    listed below from <xsl:apply-templates select="FIELD[FNAME='startDate']"/> to <xsl:apply-templates select="FIELD[FNAME='endDate']"/> at a 
