            ...
            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                ...
                <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                  <fo:block text-align="justify">
                    ...
                    <fo:inline font-size="12pt"> We wish to inform you that your license has been rejected. The reason for rejection is as
                       follows: <xsl:apply-templates select="FIELD[FNAME='rejectionReason']"/>.
                    </fo:inline>
                    <fo:block>
                      <fo:leader leader-pattern="space"/>
                    </fo:block>
