                  ...
                  <fo:block xsl:use-attribute-sets="Normal">
                    <fo:inline xsl:use-attribute-sets="Normal">
                      <fo:inline font-weight="bold">
                        <fo:inline xsl:use-attribute-sets="Normal_1">Details</fo:inline>
                      </fo:inline>
                    </fo:inline>
                  </fo:block>
                </fo:table-cell>
      ...
      <fo:table-body>
        <fo:table-row>
          <fo:table-cell xsl:use-attribute-sets="Cell_4">
            <fo:block xsl:use-attribute-sets="Normal">
              <fo:inline xsl:use-attribute-sets="Normal">
                <fo:inline xsl:use-attribute-sets="Normal_bold">Client Name</fo:inline>
              </fo:inline>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell xsl:use-attribute-sets="Cell_5">
            <fo:block xsl:use-attribute-sets="Normal">
              <fo:inline xsl:use-attribute-sets="Normal">
                <fo:inline xsl:use-attribute-sets="Normal_bold">Service Authorization No</fo:inline>
              </fo:inline>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell xsl:use-attribute-sets="Cell_5">
            <fo:block xsl:use-attribute-sets="Normal">
              <fo:inline xsl:use-attribute-sets="Normal">
                <fo:inline xsl:use-attribute-sets="Normal_bold">Expected Units</fo:inline>
              </fo:inline>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell xsl:use-attribute-sets="Cell_5">
            <fo:block xsl:use-attribute-sets="Normal">
              <fo:inline xsl:use-attribute-sets="Normal">
                <fo:inline xsl:use-attribute-sets="Normal_bold">Actual Units</fo:inline>
              </fo:inline>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
      ...
      <fo:table-body>
        <fo:table-row>
          <fo:table-cell xsl:use-attribute-sets="Cell_4">
            <fo:block xsl:use-attribute-sets="Normal">
              <fo:inline xsl:use-attribute-sets="Normal">
                <fo:inline xsl:use-attribute-sets="Normal_bold">Daily Attendance</fo:inline>
              </fo:inline>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
      ...
      <fo:table-body>
        <fo:table-row>
          <fo:table-cell xsl:use-attribute-sets="Cell_4">
            <fo:block xsl:use-attribute-sets="Normal">
              <fo:inline xsl:use-attribute-sets="Normal">
                <fo:inline xsl:use-attribute-sets="Normal_bold">Date</fo:inline>
              </fo:inline>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell xsl:use-attribute-sets="Cell_5">
            <fo:block xsl:use-attribute-sets="Normal">
              <fo:inline xsl:use-attribute-sets="Normal">
                <fo:inline xsl:use-attribute-sets="Normal_bold">Attendance</fo:inline>
              </fo:inline>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell xsl:use-attribute-sets="Cell_5">
            <fo:block xsl:use-attribute-sets="Normal">
              <fo:inline xsl:use-attribute-sets="Normal">
                <fo:inline xsl:use-attribute-sets="Normal_bold">Expected Units Attended</fo:inline>
              </fo:inline>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell xsl:use-attribute-sets="Cell_5">
            <fo:block xsl:use-attribute-sets="Normal">
              <fo:inline xsl:use-attribute-sets="Normal">
                <fo:inline xsl:use-attribute-sets="Normal_bold">Actual Units Attended</fo:inline>
              </fo:inline>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell xsl:use-attribute-sets="Cell_5">
            <fo:block xsl:use-attribute-sets="Normal">
              <fo:inline xsl:use-attribute-sets="Normal">
                <fo:inline xsl:use-attribute-sets="Normal_bold">Units Unattended</fo:inline>
              </fo:inline>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
