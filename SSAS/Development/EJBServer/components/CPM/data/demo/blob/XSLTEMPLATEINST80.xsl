              ...
              <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                <fo:block text-align="justify">
                  ...
                  <fo:inline font-size="12pt">
                    We wish to inform you that you have been suspended
                      as a provider with our agency under Reference No.
                    <xsl:apply-templates select="FIELD[FNAME='providerRefNumber']" />
                    . You have
                      been suspended for the following reason:
                    <xsl:apply-templates select="FIELD[FNAME='reason']" />
                    .
                  </fo:inline>
                  <fo:block>
                    <fo:leader leader-pattern="space" />
