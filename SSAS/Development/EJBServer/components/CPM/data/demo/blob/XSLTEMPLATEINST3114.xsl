              ...
              <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                <fo:block text-align="justify">
                  ...
                  <fo:inline font-size="12pt">
                    We wish to inform you that the due date for submitting roster for the period from
                    <xsl:apply-templates select="FIELD[FNAME='fromDate']" />
                    to
                    <xsl:apply-templates select="FIELD[FNAME='toDate']" />
                    is
                    <xsl:apply-templates select="FIELD[FNAME='submissionDueDate']" />
                    .
                  </fo:inline>
                  <fo:block>
                    <fo:leader leader-pattern="space" />
