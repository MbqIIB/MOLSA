            ...
            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
              ...
              <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                <fo:block text-align="justify">
                  ...
                  <fo:inline font-size="12pt"> We wish to inform you that you are now under contract with our agency for the following 
                    providers to deliver the services listed below to clients of this agency from 
                    <xsl:apply-templates select="FIELD[FNAME='startDate']"/>
                    to <xsl:apply-templates select="FIELD[FNAME='endDate']"/>.
                  </fo:inline>
                  <fo:block>
                    <fo:leader leader-pattern="space"/>
                  </fo:block>
