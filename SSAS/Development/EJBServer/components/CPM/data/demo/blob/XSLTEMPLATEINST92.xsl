            ...
            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
              ...
              <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                <fo:block text-align="justify">
                  ...
                  <fo:inline font-size="12pt"> We wish to inform you that you are now under contract with our agency to deliver
                    the services listed below to clients of this agency from <xsl:apply-templates select="FIELD[FNAME='startDate']"/>
