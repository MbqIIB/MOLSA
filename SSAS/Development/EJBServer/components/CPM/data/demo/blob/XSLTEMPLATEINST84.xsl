            ...
            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                ...
                <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                  <fo:block text-align="justify">
                    ...
                    <fo:inline font-size="12pt"> We wish to inform you that your license is due to expire on <xsl:apply-templates select="FIELD[FNAME='expirationDate']"/>. Please send in
