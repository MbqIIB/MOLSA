...
<ac:application xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
 ...
 id="CPMFMAPP"
 logo="CPMFMAPP.logo"
 title="CPMFMAPP.title"
 subtitle="CPMFMAPP.subtitle"
 user-message="CPMFMAPP.UserMessage">
  ...
  <!-- BEGIN, CR00281453, GP -->
  <ac:application-search default-search-page="ProviderManagement_searchByReservationStatusProviderAndClient" initial-text="Application.Search.InitialText"/>
  <!-- END, CR00281453 -->

  <ac:section-ref id="CPMFMAPPHomeSection"/>    
  <ac:section-ref id="CPMFMAPPWorkspaceSection"/>
