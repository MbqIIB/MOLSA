...
<ac:application xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
 ...
 id="CPMRMSAPP"
 logo="CPMRMSAPP.logo"
 title="CPMRMSAPP.title"
 subtitle="CPMRMSAPP.subtitle"
 user-message="CPMRMSAPP.UserMessage">
  ...
  <!-- BEGIN, CR00281847, SS -->
  <ac:application-search default-search-page="ProviderOrganization_resolveApplicationSearch" initial-text="Application.Search.InitialText"/>
  <!-- END, CR00281847 -->
  
  <ac:section-ref id="CPMRMSAPPHomeSection"/>
  <ac:section-ref id="CPMRMSAPPWorkspaceSection"/>
