...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
      ...
      <fo:page-sequence master-reference="only">
        ...
        <fo:flow flow-name="xsl-region-body">
          <xsl:apply-templates select="FIELD[FNAME='contractDetails']/STRUCT[SNAME='CompleteContractDetails']"/>
        </fo:flow>
  ...
  <xsl:template match="STRUCT[SNAME='CompleteContractDetails']">
<!-- BEGIN, CR00352142, PB -->
    ...
    <fo:block wrap-option="wrap" margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
      <fo:inline xsl:use-attribute-sets="Normal_3">Client Name: <xsl:apply-templates select="FIELD[FNAME='clientName']"/>
      </fo:inline>
      <fo:inline xsl:use-attribute-sets="Normal_3"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Social Security Number: <xsl:apply-templates select="FIELD[FNAME='ssnNumber']"/>
      </fo:inline>
    </fo:block>

    <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
      <fo:inline xsl:use-attribute-sets="Normal_3">Contract Date: <xsl:apply-templates select="FIELD[FNAME='contractDate']"/>
      </fo:inline>
      <fo:inline xsl:use-attribute-sets="Normal_3">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Plan Reference Number: <xsl:apply-templates select="FIELD[FNAME='caseReference']"/>
      </fo:inline>
    ...
    <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
      <fo:inline xsl:use-attribute-sets="Normal_3">Plan Goal: <xsl:apply-templates select="FIELD[FNAME='plannedGoalName']"/>
      </fo:inline>
    </fo:block>
    ...
    <xsl:if test="count(FIELD[FNAME='OtherSubGoalDetails']/STRUCT[SNAME='OtherPlannedSubGoalDetails']/FIELD[FNAME='subGoalDtlsForContractList']/STRUCT_LIST/STRUCT) > 0"> 
         <xsl:apply-templates select="FIELD[FNAME='OtherSubGoalDetails']/STRUCT[SNAME='OtherPlannedSubGoalDetails']"></xsl:apply-templates> 
    </xsl:if> 
  ...
  <xsl:template match="STRUCT[SNAME='ConcernRoleNameDetails']">
    ...
    <fo:table-row>
      <fo:table-cell border-bottom-width="0.5pt" padding-left="5.4pt" padding-right="5.4pt">
        <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
          <fo:inline xsl:use-attribute-sets="Normal_3">( <xsl:apply-templates select="FIELD[FNAME='concernRoleName']"/> ) &nbsp;</fo:inline>
        </fo:block>
       </fo:table-cell>
       <fo:table-cell border-bottom-width="0.5pt" padding-left="5.4pt" padding-right="5.4pt">
         <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
          ...
          <fo:table-body>
            <fo:table-row>
              <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-left="2.4pt" padding-right="2.4pt" number-columns-spanned="3">            
                <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
                  <fo:inline xsl:use-attribute-sets="Normal_3">
                     <xsl:apply-templates select="FIELD[FNAME='planItemContractText']"/>&nbsp;</fo:inline>
                </fo:block>
              </fo:table-cell>
            </fo:table-row>
