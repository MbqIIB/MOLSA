...
update securitygroupsid set GROUPNAME='BASESECURITYGROUP' where SIDNAME = 'IEGPager.gotoPage' and GROUPNAME='SUPERGROUP';
update securitygroupsid set GROUPNAME='BASESECURITYGROUP' where SIDNAME = 'IEGPager.nextPage' and GROUPNAME='SUPERGROUP';
update securitygroupsid set GROUPNAME='BASESECURITYGROUP' where SIDNAME = 'IEGPager.previousPage' and GROUPNAME='SUPERGROUP';
