              ...
              <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                <fo:block text-align="justify">
                  ...
                  <fo:block text-align="center">
                    <fo:inline font-size="16pt" font-weight="bold" >Minutes for 
                      <xsl:apply-templates select="FIELD[FNAME='minutesDtls']/STRUCT['MeetingMinutesDtls']/FIELD[FNAME='subject']"/>
                      held on <xsl:apply-templates select="FIELD[FNAME='startDate']"/> at <xsl:apply-templates select="FIELD[FNAME='startTime']"/>
                    </fo:inline>
                  </fo:block>
                  <fo:block>
                    <fo:leader leader-pattern="space"/>
