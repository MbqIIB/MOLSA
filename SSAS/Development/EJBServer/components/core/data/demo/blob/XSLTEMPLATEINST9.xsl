...
<!-- BEGIN, CR00352142, PB -->
          ...
          <fo:block xsl:use-attribute-sets="Normal_6">
            Please confirm that the following information that you provided
            to this agency is correct.
          </fo:block>
          ...
          <fo:block xsl:use-attribute-sets="Normal_6">
            Client Name:
<fo:inline-container left="120mm" space-start="30mm">
   ...
   <fo:block xsl:use-attribute-sets="Normal_3">
      &nbsp;
          ...
          <fo:block xsl:use-attribute-sets="Normal_3">
             I declare that all the details supplied are true and complete
             and that I undertake to notify the department if I get employed
             or if there is any change in the details given.
          </fo:block>
