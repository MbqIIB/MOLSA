...
<!-- BEGIN, CR00352142, PB -->
          ...
          <!-- Dear .. -->
          <fo:block xsl:use-attribute-sets="Normal_1">
            Dear <xsl:apply-templates select="./FIELD[FNAME='externalPartyDtls']/STRUCT[SNAME='ConcernNameAlternateIDRegDate']/FIELD[FNAME='concernRoleName']"/>,
          </fo:block>
          ...
          <fo:block xsl:use-attribute-sets="Normal_1">
            ...
            effective as of <xsl:apply-templates select="./FIELD[FNAME='externalPartyDtls']/STRUCT[SNAME='ConcernNameAlternateIDRegDate']/FIELD[FNAME='registrationDate']"/>.
          </fo:block>
