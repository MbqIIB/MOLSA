...
<!-- BEGIN, CR00352142, PB -->
          ...
          <fo:block
            xsl:use-attribute-sets="Normal_2">
         ...
         <fo:block
           xsl:use-attribute-sets="Normal_3">
            &nbsp;
          </fo:block>

          <fo:block
            xsl:use-attribute-sets="Normal_4">
            &nbsp;
          </fo:block>

          <fo:block
            xsl:use-attribute-sets="Normal_5">
          ...
          <fo:block
            xsl:use-attribute-sets="Normal_6">
