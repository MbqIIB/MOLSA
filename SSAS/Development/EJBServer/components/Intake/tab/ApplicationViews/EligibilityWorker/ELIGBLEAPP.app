...
<ac:application xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    id="ELIGBLEAPP"
    logo="ELIGBLEAPP.logo"
    title="ELIGBLEAPP.title"
    subtitle="ELIGBLEAPP.subtitle"
    user-message="ELIGBLEAPP.UserMessage">
    ...
    <ac:application-search default-search-page="Intake_resolveQuickSearch" initial-text="Application.Search.InitialText"/>
      ...
      <ac:section-ref id="ELIGBLEHOMEWorkspaceSection"/>

     <ac:section-ref id="ELIGBLEAPPWorkspaceSection"/>
