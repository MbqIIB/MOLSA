...
:تاريخ تقديم الطلب </fo:block>
    ...
    <fo:inline> : </fo:inline>
	<xsl:apply-templates select="FIELD[FNAME='benefNomineeName']" /> <fo:leader leader-length="20mm"/> 
      <fo:inline font-weight="bold">رقم البطاقة</fo:inline>
      <fo:inline>:</fo:inline>
      <xsl:apply-templates select="FIELD[FNAME='nomineeAlternateID']" />   </fo:block>
	...
	<xsl:apply-templates select="FIELD[FNAME='benefNomineeName']"/> <fo:leader leader-length="20mm"/> 
      ...
      <fo:inline font-weight="bold">رقم البطاقة</fo:inline>
      <fo:inline>:</fo:inline>    
      <xsl:apply-templates select="FIELD[FNAME='nomineeAlternateID']" />
    </fo:block>
	
    <fo:block xsl:use-attribute-sets="Normal_5">
      <fo:inline font-weight="bold">تاريخ المراجعة</fo:inline>
      <fo:inline>:</fo:inline>
      <xsl:apply-templates select="FIELD[FNAME='inquiryReviewDate']" />  
    </fo:block>
