 ...
 <xsl:attribute-set name="Normal_3" foa:class="block">
  ...
  <fo:root>
    <fo:layout-master-set>
      <fo:simple-page-master master-name="only" page-height="297mm" page-width="210mm"   margin-top="50mm" margin-bottom="20mm" margin-left="30mm" margin-right="30mm">
          <fo:region-body /> 
		...
		<fo:page-sequence master-reference="only">	          
            <fo:flow flow-name="xsl-region-body"  font-family="Times New Roman" >
                ...
                <fo:block  xsl:use-attribute-sets="Normal_1"  font-weight="bold" text-align="center"  text-decoration="underline">
                ...
                <fo:block   font-size="20pt"   text-align="right" margin-top="5mm" >
                    
                   <fo:inline> 
                    و يصرف له/لها معاشاً شهريا آخر مقداره  
                   </fo:inline>
                    
                    <!-- Maid Allowance Amount-->
                    <xsl:apply-templates select="FIELD[FNAME='maidAssistanceAmount']"/>
                    <fo:inline>
                         ريال لكونه/ كونها  بدل خادم 
                    </fo:inline>
                ...
                <fo:block   font-size="20pt"  font-weight="bold" text-align="center" margin-top="5mm" >
            ...
            <fo:external-graphic src="MOLSA/signature-blue.png"  content-height="scale-to-fit" height="10.96mm" padding-left="13mm"/> </fo:block>
                <fo:block   font-size="20pt"  font-weight="bold" text-align="left" margin-top="5mm" margin-left="11mm" >
                    
                    <xsl:apply-templates select="FIELD[FNAME='molsaManagerName']"/> 
                    
                </fo:block>  
                
                <fo:block   font-size="20pt"  font-weight="bold" text-align="left" margin-top="5mm" >
                    
                    مدير إدارة الضمان  الاجتماعي 
                    
                </fo:block>  
                
                <fo:block   font-size="16pt"   text-align="right" margin-top="15mm" font-weight="bold" >
                    
                    تنتهي صلاحيات هذه الشهادة بعد مرور ثلاثة أشهر من تاريخ الاصدار 
                </fo:block> 
                <fo:block   font-size="9pt"   text-align="right" margin-top="10mm"  >                    
                    <fo:inline>نسخة لملف الحالة رقم:</fo:inline>
                    <xsl:apply-templates select="FIELD[FNAME='caseReferenceID']" />                    
                </fo:block> 
                
                <fo:block   font-size="9pt"   text-align="right" margin-top="2mm" >
