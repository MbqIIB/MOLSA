...
<xsl:stylesheet extension-element-prefixes="redirect xalan"
  ...
  <xsl:template name="CreateContentVIM">
    ...
    <xsl:variable name="facadeCreateMethod">create<xsl:value-of select="$entityName"/>Evidence</xsl:variable>
            ...
            <FIELD>
              ...
              <xsl:choose>
                ...
                <xsl:when test="@metatype=$metatypeParentCaseParticipant">
                  ...
                  <CONNECT>
                    <SOURCE NAME="{@columnName}" PROPERTY="name"/>
                  </CONNECT>
                </xsl:when>
                ...
                <xsl:when test="@metatype=$metatypeDisplayCaseParticipant">
                  ...
                  <CONNECT>
                    <SOURCE NAME="PARTICIPANTDETAILS" PROPERTY="name"/>
                  </CONNECT>
                </xsl:when>
