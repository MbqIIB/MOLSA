  ...
  <LIST>
    ...
    <ACTION_SET TYPE="LIST_ROW_MENU">
      ...
      >
        ...
        <LINK
          OPEN_MODAL="true"
          PAGE_ID="DecisionAssistAdmin_modifyICDCodeTranslation"
          WINDOW_OPTIONS="width=250"
        >
          <!-- END, CR00198297 -->
          <!-- END, CR00198884 -->
          <!-- END, CR00207167 -->
      ...
      >
        ...
        <LINK
          OPEN_MODAL="true"
          PAGE_ID="DecisionAssistAdmin_deleteICDCodeTranslation"
        ...
        >
          ...
          <CONNECT>
            <SOURCE
              NAME="VIEW_ICD_CODE"
              PROPERTY="result$viewCodeDtls$viewDtls$ICDCodeID"
            />
            <TARGET
              NAME="PAGE"
              PROPERTY="ICDCodeID"
