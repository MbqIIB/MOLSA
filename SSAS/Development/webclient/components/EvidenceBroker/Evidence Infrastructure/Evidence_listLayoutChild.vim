...
<!-- Description                                                            -->
<!-- ===========                                                            -->
<!--  List of child evidence for a parent.                                  -->
<VIEW
...
>
  ...
  >
    ...
    <FIELD
      LABEL="List.Title.SharedStatus"
      WIDTH="8"
    >
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
          PROPERTY="activeList$dtls$sharedStatus"
        />
      </CONNECT>
    </FIELD>
    <FIELD
  ...
  <CLUSTER
    ...
    SHOW_LABELS="false"
    STYLE="evidence-workspace-cluster"
  ...
  >
    ...
    <!-- BEGIN, HARP 64908, SP -->
    <LIST
      DESCRIPTION="Cluster.WIP.Update.Description"
      TITLE="List.Title.NewAndUpdateList"
    >
      <!-- END, HARP 64908 -->
      <!-- END, CR00050298 -->
      ...
      >
        <CONNECT>
          <SOURCE
            NAME="DISPLAY"
            PROPERTY="newAndUpdateList$dtls$sharedStatus"
          />
        </CONNECT>
      </FIELD>
      <FIELD
    ...
    <!-- BEGIN, HARP 64908, SP -->
    <LIST
      DESCRIPTION="Cluster.WIP.Remove.Description"
      TITLE="List.Title.RemovalList"
    >
      <!-- END, HARP 64908 -->
      <!-- END, CR00050298 -->
        ...
        <ACTION_CONTROL LABEL="ActionControl.Label.Undo">
          ...
          >
            ...
            <CONNECT>
              <SOURCE
                NAME="DISPLAY"
                PROPERTY="removeList$dtls$versionNo"
              />
              <TARGET
                NAME="PAGE"
                PROPERTY="versionNo"
      ...
      >
        <CONNECT>
          <SOURCE
            NAME="DISPLAY"
            PROPERTY="removeList$dtls$sharedStatus"
          />
        </CONNECT>
      </FIELD>
      <FIELD
  ...
  <!-- BEGIN, CR00021605, NK -->
  <INCLUDE FILE_NAME="VerificationApplication_listEvidenceTypeVerificationRequirements.vim"/>
  <!-- END, CR00021605-->
</VIEW>
