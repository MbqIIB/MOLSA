    ...
    <FIELD LABEL="Field.Label.Name">
      ...
      <LINK PAGE_ID="Participant_resolveRoleHome">
        <CONNECT>
          <SOURCE
            NAME="DISPLAY"
            PROPERTY="liabilityHeaderDetails$concernRoleID"
          />
          <TARGET
            NAME="PAGE"
        ...
        <CONNECT>
          <SOURCE
            NAME="DISPLAY"
            PROPERTY="liabilityHeaderDetails$concernRoleType"
          />
          <TARGET
            NAME="PAGE"
  ...
  <LIST TITLE="Cluster.Title.LineItems">
    ...
    >
      ...
      <ACTION_CONTROL LABEL="ActionControl.Label.View">
        ...
        <LINK
          PAGE_ID="Financial_viewLiabilityLineItem"
          SAVE_LINK="false"
        >
          <!-- END, CR00095798 -->
          <CONNECT>
      ...
      <ACTION_CONTROL LABEL="ActionControl.Label.ViewAllocations">
        <!-- BEGIN, CR00095798, GSP  -->
        <LINK
          PAGE_ID="Financial_viewLineItemAllocation"
          SAVE_LINK="false"
        >
          <!-- END, CR00095798 -->
          <CONNECT>
