...
>
  ...
  <SERVER_INTERFACE CLASS="Person" NAME="DISPLAY" OPERATION="readForeignResidency" />

  <PAGE_PARAMETER NAME="foreignResidencyID" />


  <CONNECT>
    <SOURCE NAME="PAGE" PROPERTY="foreignResidencyID" />
    <TARGET NAME="DISPLAY" PROPERTY="readForeignResidencyKey$foreignResidencyID" />
  </CONNECT>
  ...
  <CLUSTER NUM_COLS="2" TITLE="Cluster.Label.Details">
    ...
    <FIELD LABEL="Field.Label.Country">
      <CONNECT>
        <SOURCE NAME="DISPLAY" PROPERTY="countryCode" />
      </CONNECT>
    </FIELD>
