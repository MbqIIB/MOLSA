...
-->
<VIEW
  PAGE_ID="ProcessDefinitionTool_viewManualActivityRuleAllocationStrategy"
  ...
  <LIST TITLE="List.Title.InputMappings">
    <ACTION_SET TYPE="LIST_ROW_MENU">
      <ACTION_CONTROL LABEL="Action.Label.Edit">
        <LINK
          OPEN_MODAL="true"
          PAGE_ID="ProcessDefinitionTool_editManualActivityRuleAllocationInputMapping"
        >
          <CONNECT>
            <SOURCE
              NAME="PAGE"
    ...
    <FIELD LABEL="Field.Label.RDOAttributeToSet">
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
          PROPERTY="result$mapping$dtls$rdoAttribute"
    ...
    <FIELD LABEL="Field.Label.RDOAttributeType">
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
    ...
    <FIELD LABEL="Field.Label.WDOAttributeToSet">
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
