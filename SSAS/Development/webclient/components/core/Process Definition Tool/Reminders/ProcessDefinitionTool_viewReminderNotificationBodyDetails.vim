...
-->
<VIEW
  PAGE_ID="ProcessDefinitionTool_viewReminderNotificationBodyDetails"
...
>
  ...
  <SERVER_INTERFACE
    CLASS="ReminderAdmin"
    NAME="DISPLAY"
    OPERATION="readReminderNotificationBody"
    PHASE="DISPLAY"
  />
  <CONNECT>
    <SOURCE
  ...
  <CLUSTER
    SHOW_LABELS="false"
    TITLE="Cluster.NotificationBody"
  >
    <FIELD>
      <CONNECT>
        <SOURCE
  ...
  >
    <ACTION_SET TYPE="LIST_ROW_MENU">
      <ACTION_CONTROL LABEL="Action.Label.Reorder">
        <LINK
          OPEN_MODAL="true"
          PAGE_ID="ProcessDefinitionTool_reorderReminderNotificationBodyTextParameter"
        >
          <CONNECT>
            <SOURCE
              NAME="PAGE"
      ...
      <ACTION_CONTROL LABEL="Action.Label.Delete">
        <LINK
          OPEN_MODAL="true"
          PAGE_ID="ProcessDefinitionTool_deleteReminderNotificationBodyTextParameter"
        >
          <CONNECT>
            <SOURCE
              NAME="PAGE"
