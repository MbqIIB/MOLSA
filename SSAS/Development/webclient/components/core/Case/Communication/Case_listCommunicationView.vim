...
<!-- Description                                                            -->
<!-- ===========                                                            -->
<!-- The included view for a list of case communications.                 -->
<!-- BEGIN, CR00264374, JAF -->
<?curam-deprecated Since Curam 6.0 SP1, replaced with Case_listCommunicationViewAndResolveWithCorrespondent.vim. See release note: CR00264374?>
<!-- END, CR00264374, JAF -->
<VIEW
...
>
  ...
  <ACTION_SET BOTTOM="false">
    ...
    >
      ...
      <LINK
        OPEN_MODAL="true"
        PAGE_ID="Case_getMSWordCorrespondent"
      >
        <CONNECT>
          <SOURCE
            NAME="PAGE"
  ...
  <LIST>
    ...
    <DETAILS_ROW>
      ...
      <INLINE_PAGE PAGE_ID="Participant_resolveViewCommunication">
        <CONNECT>
          <SOURCE
            NAME="DISPLAY"
