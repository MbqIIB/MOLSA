...
>
  ...
  <CLUSTER SHOW_LABELS="false">
    <CONTAINER>
      ...
      >
        <LINK
          ...
          WINDOW_OPTIONS="width=550,height=150"
        >
          <CONNECT>
            <SOURCE
              NAME="PAGE"
    ...
    <CONTAINER>
      <ACTION_CONTROL
        IMAGE="ActivateIcon"
        LABEL="Field.StaticText.OnlineActivate"
      >
        <LINK
          OPEN_MODAL="true"
  ...
  <CLUSTER SHOW_LABELS="false">
    ...
    <CONTAINER>
      ...
      >
        <LINK
          ...
          WINDOW_OPTIONS="width=610,height=210"
        >
          <CONNECT>
            <SOURCE
              NAME="PAGE"
    ...
    <CONTAINER>
      <ACTION_CONTROL
        IMAGE="ReassessIcon"
        LABEL="ActionControl.Label.Reassess"
      >
        <LINK
          OPEN_MODAL="true"
  ...
  <CLUSTER SHOW_LABELS="false">
    <CONTAINER>
      <ACTION_CONTROL
        IMAGE="SuspendIcon"
        LABEL="Field.StaticText.Suspend"
      >
        <LINK
          OPEN_MODAL="true"
          PAGE_ID="ProductDelivery_suspend"
          WINDOW_OPTIONS="width=700,height=270"
        >
          <CONNECT>
            <SOURCE
              NAME="PAGE"
    ...
    <CONTAINER>
      <ACTION_CONTROL
        IMAGE="UnsuspendIcon"
        LABEL="Field.StaticText.Unsuspend"
      >
        <LINK
          OPEN_MODAL="true"
    ...
    <CONTAINER>
      <ACTION_CONTROL
        IMAGE="ReactivateIcon"
        LABEL="Field.StaticText.Reactivate"
      >
        <LINK
          OPEN_MODAL="true"
