...
<!-- Description -->
<!-- =========== -->
<!-- The included view for a list of integrated case events.                -->
<VIEW xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="file://Curam/UIMSchema.xsd">
  ...
  <SERVER_INTERFACE CLASS="IntegratedCase" NAME="DISPLAY" OPERATION="listEvent1"/>
    ...
    <DETAILS_ROW>
      <INLINE_PAGE PAGE_ID="Case_resolveEventView">
        ...
        <CONNECT>
          ...
          <TARGET NAME="PAGE" PROPERTY="meetingMinutesID"/>
        </CONNECT>
      </INLINE_PAGE>
    </DETAILS_ROW>
