...
<!-- Description                                                            -->
<!-- ===========                                                            -->
<!--The included view to display a list of accessible integrated case notes.-->
<?curam-deprecated Since Curam 6.0, replaced by IC_listAccessibleNoteView1.vim?>
<VIEW
...
>
  ...
  <MENU MODE="INTEGRATED_CASE">
    <CONNECT>
      <SOURCE
        NAME="DISPLAY"
        PROPERTY="result$icMenuData$menuData"
      />
    </CONNECT>
  </MENU>
    ...
    >
      <ACTION_CONTROL LABEL="ActionControl.Label.View">
        <CONDITION>
          <IS_FALSE
            NAME="DISPLAY"
            PROPERTY="result$noteDetailsList$dtls$noteAccessInd"
          />
        </CONDITION>
