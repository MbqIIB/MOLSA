...
<!-- Description                                                            -->
<!-- ===========                                                            -->
<!-- The included view to display a list of active third party deductions   -->
...
>
  ...
  <SERVER_INTERFACE
    ...
    NAME="DISPLAY"
    OPERATION="listThirdPartyDeduction"
  />
  ...
  <LIST DESCRIPTION="Cluster.Description.Tax">
    ...
    <ACTION_SET TYPE="LIST_ROW_MENU">
      ...
      <ACTION_CONTROL LABEL="ActionControl.Label.Edit">
        <LINK
          OPEN_MODAL="true"
          PAGE_ID="ProductDelivery_modifyThirdPartyDeductionFromList"
        >
          <CONNECT>
            <SOURCE
              NAME="DISPLAY"
    ...
    <DETAILS_ROW>
      <INLINE_PAGE PAGE_ID="ProductDelivery_viewThirdPartyDeductionDetails">
        <CONNECT>
          <SOURCE
            NAME="DISPLAY"
            PROPERTY="caseDeductionItemID"
