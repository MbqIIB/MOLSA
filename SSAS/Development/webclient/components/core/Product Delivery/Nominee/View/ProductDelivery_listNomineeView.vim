...
<!-- BEGIN, CR00238896, GD -->
<?curam-deprecated Since Curam 6.0, replaced with ProductDelivery_listNomineeView1?>
<!-- END, CR00238896 -->
<VIEW
    ...
    >
      ...
      >
        ...
        <CONNECT>
          <SOURCE
            NAME="DISPLAY"
            PROPERTY="result$caseContextDescription$description"
          />
          <TARGET
            NAME="PAGE"
      ...
      <ACTION_CONTROL LABEL="ActionControl.Label.Edit">
        ...
        >
          <CONNECT>
            <SOURCE
              NAME="DISPLAY"
              PROPERTY="result$caseNomineeDetailsList$caseNomineeDetailsList$caseNomineeID"
            />
            <TARGET
              NAME="PAGE"
