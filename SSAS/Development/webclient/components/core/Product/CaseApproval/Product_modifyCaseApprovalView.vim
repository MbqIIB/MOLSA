...
<!-- Description                                                            -->
<!-- ===========                                                            -->
<!-- The included view for the modify product case approval pages.          -->
<VIEW
...
>
  ...
  <SERVER_INTERFACE
    CLASS="Product"
    NAME="DISPLAY"
    OPERATION="readProductApprovalCheck"
  />
  ...
  <SERVER_INTERFACE
    CLASS="Product"
    NAME="ACTION"
    OPERATION="modifyProductApprovalCheck"
    PHASE="ACTION"
  />
  ...
  <CONNECT>
    ...
    <TARGET
      NAME="DISPLAY"
      PROPERTY="productContextDescriptionKey$productID"
    />
  </CONNECT>
