...
<!-- Description -->
<!-- =========== -->
<!-- The included view for the modify user resolution approval pages.            -->
<VIEW
...
>
  ...
  <SERVER_INTERFACE
    CLASS="Organization"
    NAME="DISPLAY"
    OPERATION="readResolutionApprovalCheckForUser"
  />
  ...
  <SERVER_INTERFACE
    CLASS="Organization"
    NAME="ACTION"
    OPERATION="modifyResolutionApprovalCheckForUser"
    PHASE="ACTION"
  />
