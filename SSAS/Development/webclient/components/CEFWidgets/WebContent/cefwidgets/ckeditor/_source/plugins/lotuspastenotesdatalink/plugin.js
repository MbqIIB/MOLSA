...
(function()
{
	...
	CKEDITOR.plugins.add('lotuspastenotesdatalink', {

		init : function(editor)	{

			editor.on('paste', function(evt) {
				var data = evt.data;
				var linkText = data.html;
				if (linkParser.parse(linkText)) {
					data.html = linkParser.createLink(linkText);
				}
			});
		},
		linkParser : linkParser			//exposes linkParser as an available object on the lotuspastenotesdatalink plugin
	});
})();
