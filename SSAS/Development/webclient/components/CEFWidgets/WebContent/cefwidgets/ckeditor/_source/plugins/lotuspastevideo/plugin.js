...
CKEDITOR.plugins.add('lotuspastevideo', {
	...
	init : function(editor)	{
			...
			this.parse = function()  {
				...
				if (CKEDITOR.env.ie) {
					...
					if (isObjectEmbedRegex.test(_html)) {
						...
						// IE9/10 creates extra tags - use regex to remove them.
		...
		editor.on('paste', function(evt) {
			var videoParser = new VideoParser(evt.data.html);

			if (videoParser.parse()) {
