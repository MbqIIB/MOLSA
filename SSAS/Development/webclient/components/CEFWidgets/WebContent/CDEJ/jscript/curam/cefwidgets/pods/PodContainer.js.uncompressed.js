  ...
  showRemainingPods: function(/*Object*/ gridContainer){
   ...
   //   quicker because they do not have to wait for all Pods to be loaded.
    ...
    dojo.forEach( hiddenPods, function(hiddenPod){
      ...
      var podFilterButtonAltText = dojo.attr(hiddenPod, "podFilterButtonAltText");
      var podCloseButtonAltText = dojo.attr(hiddenPod, "podCloseButtonAltText");
      var expandCollapsePodButtonAltText = dojo.attr(hiddenPod, "expandCollapsePodButtonAltText");
      ...
      var podWidget = new curam.cefwidgets.pods.Pod({
        ...
        podFilterButtonAltText: podFilterButtonAltText,
        expandCollapsePodButtonAltText: expandCollapsePodButtonAltText,
        'class': classList,
        content: podContents
      });
