...
<VIEW xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="file://Curam/UIMSchema.xsd">
  ...
  <ACTION_SET>
    <ACTION_CONTROL LABEL="ActionControl.Label.SubscribeToWorkQueue">
      <LINK OPEN_MODAL="true" PAGE_ID="Supervisor_subscribeUserToWorkQueue" SAVE_LINK="true" WINDOW_OPTIONS="width=600">
        <CONNECT>
    ...
    <ACTION_CONTROL LABEL="ActionControl.Label.ReserveAssignedTasks">
      <LINK OPEN_MODAL="true" PAGE_ID="Supervisor_reserveAssignedtasksForUser" SAVE_LINK="true" WINDOW_OPTIONS="width=600">
        <CONNECT>
          <SOURCE NAME="DISPLAYCHART" PROPERTY="key$userName"/>
          <TARGET NAME="PAGE" PROPERTY="userName"/>
        </CONNECT>
    ...
    <ACTION_CONTROL LABEL="ActionControl.Label.TaskRedirection">
      <LINK OPEN_MODAL="true" PAGE_ID="Supervisor_redirectTasksToUsers" SAVE_LINK="true" WINDOW_OPTIONS="width=600">
        <CONNECT>
          <SOURCE NAME="DISPLAYCHART" PROPERTY="key$userName"/>
          <TARGET NAME="PAGE" PROPERTY="userName"/>
        </CONNECT>
    ...
    <ACTION_CONTROL LABEL="ActionControl.Label.ReserveTasksFromWorkQueue">
      <LINK OPEN_MODAL="true" PAGE_ID="Supervisor_reserveWorkQueueTasksForUser" SAVE_LINK="true" WINDOW_OPTIONS="width=600">
        <CONNECT>
          <SOURCE NAME="DISPLAYCHART" PROPERTY="key$userName"/>
          <TARGET NAME="PAGE" PROPERTY="userName"/>
        </CONNECT>
    ...
    <ACTION_CONTROL LABEL="ActionControl.Label.TaskAllocationBlocking">
      <LINK OPEN_MODAL="true" PAGE_ID="Supervisor_taskAllocationBlocking" SAVE_LINK="true" WINDOW_OPTIONS="width=600">
        <CONNECT>
          <SOURCE NAME="DISPLAYCHART" PROPERTY="key$userName"/>
          <TARGET NAME="PAGE" PROPERTY="userName"/>
        </CONNECT>
