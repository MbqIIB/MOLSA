// Downloaded from http://ajax.googleapis.com/ajax/libs/chrome-frame/1/CFInstall.js
//
// See Wiki page for modifications made by Curam to this file
// http://curzilla/EJB/TechInf/ClientTeam/WhitePapers/JavaScriptLibraryModifications
//
// ================================================================================
...
(function(scope) {
  ...
  var setProperties = function(node, args) {
    ...
    // If the default location is being used then do not attempt to access it 
    // with Ajax as it will cause a cross-domain error to occur in IE7.
    if (src.indexOf("www.google.com/chromeframe") == -1) {
      ...
      var xhrArgs = {
          ...
          load: function(data) {
            // The URL is accessible so display the contents.
            node.src = src;
          },

          error: function(error) {
            // The URL is not accessible so display an error page.
            node.src = 'gcf-error.jspx';
          },
      ...
      // This is the default Google Chrome Frame download page.
      node.src = src;
    }
