//>>built
define("curam/matrix/OutcomeCell",["dijit","dojo","dojox","dojo/require!curam/matrix/Constants"],function(_1,_2,_3){
_2.provide("curam.matrix.OutcomeCell");
_2.require("curam.matrix.Constants");
_2.declare("curam.matrix.OutcomeCell",null,{constructor:function(_4){
this.node=_4;
...
},setButtonClass:function(_8){
if(!this.button){
this.button=_2.create("div");
this.node.appendChild(this.button);
this.button._conn=_2.connect(this.button,"onclick",this,"createWidget");
}
cm.setClass(this.button,_8);
if(!this.widgetCreated&&_8=="image"){
this.initListener();
}
},adjustFirstRowClass:function(_9){
var _a=_2.attr(this.node,"class");
if(_a.indexOf("ans-eval-with-menu")==-1){
_a=_a.replace("ans-eval","ans-eval-with-menu");
cm.setClass(this.node,_a);
}
_a=_2.attr(this.input,"class");
if(_a.indexOf("cbox-eval-with-menu")==-1){
_a=_a.replace("cbox-eval","cbox-eval-with-menu");
cm.setClass(this.input,_a);
}
}});
});
