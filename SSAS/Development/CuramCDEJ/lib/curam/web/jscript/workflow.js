...
_13=createUse(x+55,y+14,"#_i"+_14);
}else{
if(_14==parent.endType){
_13=createUse(x+7,y+14,"#_i"+_14);
}else{
...
openLinkFromAnchor(_44);
return false;
};
};
parent.dojo.require("curam.util.Navigation");
function openLinkFromAnchor(_45){
parent.curam.util.Navigation.goToUrl(_45);
};
