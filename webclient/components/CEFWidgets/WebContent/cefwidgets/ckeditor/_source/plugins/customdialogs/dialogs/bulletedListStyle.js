...
CKEDITOR.tools.extend(CKEDITOR.ibm.dialogs, {
	...
	bulletedListStyle : function(dialogDefinition, editor) {
		...
		dialogDefinition.title = editor.lang.ibm.list.bulletedTitle;
		...
		[
			{
				...
				id : 'description',
				focus : false,
				html : '<div style="padding-bottom: 10px;">' + editor.lang.ibm.list.description + '</div>'
			},
			{
				type : 'hbox',
				widths : [ '50%', '50%' ],
				children : [
					...
					{
						type : 'select',
						label : editor.lang.ibm.list.fontsize,
						id : 'fontSize',
						style: 'width: 99%',
