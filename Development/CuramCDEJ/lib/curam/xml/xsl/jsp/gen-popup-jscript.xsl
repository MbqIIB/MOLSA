...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="APP_CONFIG">
    ...
    <xsl:text>require(["curam/omega3-util"]);</xsl:text>
    <xsl:text>setPopupProperties("../CDEJ/popups/date-selector.jsp","SVR_DATE","",209,193,false,null,null,null);&#xa;</xsl:text>
    <xsl:text>setPopupProperties("../CDEJ/popups/date-selector.jsp","SVR_DATETIME","",209,193,false,null,null,null);&#xa;</xsl:text>
    <xsl:text>setPopupProperties("frequency-editor.jsp","FREQUENCY_PATTERN","",640,undefined,false,null,null,null);&#xa;</xsl:text>
  </xsl:template>
  <xsl:template match="POPUP_PAGE">
    ...
    <xsl:text>setPopupProperties("</xsl:text>
