...
<axsl:if test="not(@NAME = 'PAGE') and not(@NAME = 'BROWSER')                     and not(key('si-by-name',                                 concat(ancestor::PAGE/@PAGE_ID, '.', @NAME)))">
<axsl:message>
<axsl:text>:</axsl:text>
<axsl:call-template name="escape-string">
<axsl:with-param name="string">
...
<axsl:choose>
<axsl:when test="count(*) = count(IS_TRUE | IS_FALSE)"/>
<axsl:otherwise>
<axsl:message>
<axsl:text>:</axsl:text>
<axsl:call-template name="escape-string">
...
<axsl:call-template name="escape-string">
<axsl:with-param name="string">
<axsl:value-of select="'IS_TRUE, IS_FALSE'"/>
</axsl:with-param>
<axsl:with-param select="$chars-to-escape" name="chars-to-escape"/>
</axsl:call-template>
<axsl:text>)</axsl:text>
...
<axsl:if test="@*[not(namespace-uri() or name() = '__line' or name() = '__file' or name() = 'TOP' or name() = 'BOTTOM' or name() = 'ALIGNMENT' or name() = 'TYPE')]">
<axsl:message>
<axsl:text>:</axsl:text>
<axsl:call-template name="escape-string">
<axsl:with-param name="string">
...
<axsl:call-template name="escape-string">
<axsl:with-param name="string">
<axsl:value-of select="'TOP, BOTTOM, ALIGNMENT, TYPE'"/>
</axsl:with-param>
<axsl:with-param select="$chars-to-escape" name="chars-to-escape"/>
</axsl:call-template>
<axsl:text>)</axsl:text>
...
<axsl:template mode="M7" priority="3979" match="SEPARATOR">
<axsl:if test="@*[not(namespace-uri() or name() = '__line' or name() = '__file')]">
<axsl:message>
<axsl:text>:</axsl:text>
<axsl:call-template name="escape-string">
...
<axsl:template mode="M7" priority="3978" match="SERVER_INTERFACE">
...
<axsl:template mode="M7" priority="3977" match="INITIAL">
...
<axsl:template mode="M7" priority="3976" match="LINK">
...
<axsl:template mode="M7" priority="3975" match="ACTION_CONTROL">
...
<axsl:template mode="M7" priority="3974" match="IMAGE">
...
<axsl:template mode="M7" priority="3973" match="CONTAINER">
...
<axsl:template mode="M7" priority="3972" match="CLUSTER">
...
<axsl:template mode="M7" priority="3971" match="LIST">
...
<axsl:choose>
<axsl:when test="count(*) = count(CONDITION | TITLE | DESCRIPTION | ACTION_SET | DETAILS_ROW | FIELD | ACTION_CONTROL | CONTAINER | FOOTER_ROW | WIDGET)"/>
<axsl:otherwise>
<axsl:message>
<axsl:text>:</axsl:text>
<axsl:call-template name="escape-string">
...
<axsl:call-template name="escape-string">
<axsl:with-param name="string">
<axsl:value-of select="'CONDITION, TITLE, DESCRIPTION, ACTION_SET, DETAILS_ROW, FIELD, ACTION_CONTROL, CONTAINER, FOOTER_ROW, WIDGET'"/>
</axsl:with-param>
<axsl:with-param select="$chars-to-escape" name="chars-to-escape"/>
</axsl:call-template>
<axsl:text>)</axsl:text>
...
<axsl:template mode="M7" priority="3970" match="FOOTER_ROW">
<axsl:if test="@*[not(namespace-uri() or name() = '__line' or name() = '__file')]">
<axsl:message>
<axsl:text>:</axsl:text>
<axsl:call-template name="escape-string">
...
<axsl:call-template name="escape-string">
<axsl:with-param name="string">
<axsl:value-of select="'EDITABLE, LABEL_ABBREVIATION, LABEL, DESCRIPTION, PROMPT, INITIAL_FOCUS, ALT_TEXT, CONTROL, WIDTH, WIDTH_UNITS, USE_BLANK, USE_DEFAULT, HEIGHT, DOMAIN, ALIGNMENT, CONFIG, APPEND_ELLIPSIS'"/>
</axsl:with-param>
<axsl:with-param select="$chars-to-escape" name="chars-to-escape"/>
</axsl:call-template>
<axsl:text>)</axsl:text>
...
<axsl:template mode="M7" priority="3968" match="WIDGET">
...
<axsl:choose>
<axsl:when test="not(@TYPE) or @TYPE = 'CONTENT' or @TYPE = 'FILE_UPLOAD' or @TYPE = 'FILE_EDIT' or @TYPE = 'MULTISELECT' or @TYPE = 'SINGLESELECT' or @TYPE = 'RULES_SIMULATION_EDITOR' or @TYPE = 'FILE_DOWNLOAD' or @TYPE = 'WIZARD_SUMMARY' or @TYPE = 'IEG_PLAYER' or @TYPE = 'USER_PREFERENCE_EDITOR'"/>
<axsl:otherwise>
<axsl:message>
<axsl:text>:</axsl:text>
<axsl:call-template name="escape-string">
...
<axsl:call-template name="escape-string">
<axsl:with-param name="string">
<axsl:value-of select="'CONTENT, FILE_UPLOAD, FILE_EDIT, MULTISELECT, SINGLESELECT, RULES_SIMULATION_EDITOR, FILE_DOWNLOAD, WIZARD_SUMMARY, IEG_PLAYER, USER_PREFERENCE_EDITOR'"/>
</axsl:with-param>
<axsl:with-param select="$chars-to-escape" name="chars-to-escape"/>
</axsl:call-template>
<axsl:text>)</axsl:text>
...
<axsl:template mode="M7" priority="3967" match="WIDGET_PARAMETER">
<axsl:if test="@*[not(namespace-uri() or name() = '__line' or name() = '__file' or name() = 'NAME')]">
<axsl:message>
<axsl:text>:</axsl:text>
<axsl:call-template name="escape-string">
...
<axsl:template mode="M7" priority="3966" match="JSP_SCRIPTLET">
<axsl:if test="@*[not(namespace-uri() or name() = '__line' or name() = '__file')]">
<axsl:message>
<axsl:text>:</axsl:text>
<axsl:call-template name="escape-string">
...
<axsl:template mode="M7" priority="3965" match="SCRIPT">
<axsl:if test="@*[not(namespace-uri() or name() = '__line' or name() = '__file' or name() = 'EVENT' or name() = 'ACTION' or name() = 'SCRIPT_FILE')]">
<axsl:message>
<axsl:text>:</axsl:text>
<axsl:call-template name="escape-string">
<axsl:with-param name="string">
...
<axsl:call-template name="escape-string">
<axsl:with-param name="string">
<axsl:value-of select="'EVENT, ACTION, SCRIPT_FILE'"/>
</axsl:with-param>
<axsl:with-param select="$chars-to-escape" name="chars-to-escape"/>
</axsl:call-template>
<axsl:text>)</axsl:text>
...
<axsl:if test="not(@EVENT) or @EVENT=''">
<axsl:message>
<axsl:text>:</axsl:text>
<axsl:call-template name="escape-string">
<axsl:with-param name="string">
...
<axsl:if test="not(@ACTION) or @ACTION=''">
<axsl:message>
<axsl:text>:</axsl:text>
<axsl:call-template name="escape-string">
<axsl:with-param name="string">
...
<axsl:template mode="M7" priority="3964" match="DESCRIPTION">
<axsl:if test="@*[not(namespace-uri() or name() = '__line' or name() = '__file' or name() = 'SEPARATOR')]">
<axsl:message>
<axsl:text>:</axsl:text>
<axsl:call-template name="escape-string">
...
<axsl:template mode="M7" priority="3963" match="INLINE_PAGE">
...
<axsl:template mode="M7" priority="3962" match="DETAILS_ROW">
