...
this._toolTipDialogExpand=new idx.oneui.HoverCard({draggable:false,hideDelay:450,showDelay:0,target:this._expandButton.domNode,content:_31,forceFocus:true,focus:_2.hitch(this,function(){
var _32=this._menuPaneButtonIndexer.getButtonSecondary(0);
_32.button.focus();
...
this._listWrapper=new curam.widget.componentWrappers.ListWraper({listType:"ol",role:"menu",baseClass:this._classNavMenu,_doBeforeItemSet:_2.hitch(this,function(_33,_34){
if(_33!=null&&_33.orgID!="exapnadButton"){
_3.remove(_33.iconNode,this._classCurramSideMenuOverFlowButtonIcon);
if(has("ie")){
_3.remove(_33.domNode,"curramSideMenuOverFlowButtonHover");
}
_12.set(_33.focusNode,"textAlign","center");
if(this.isLeftToRight()){
_12.set(_33.containerNode,"marginRight","0px");
}else{
_12.set(_33.containerNode,"marginLeft","0px");
}
_33.set("baseClass",this._classCurramSideMenuButton);
_3.replace(_33.domNode,this._classCurramSideMenuButton,this._classCurramSideMenuOverFlowButton);
}
})});
if(has("ie")!=null&&has("ie")<9){
var _35=_7.create("div",null,this.containerNode);
_13.set(_35,"role","navigation");
this._listWrapper.placeAt(_35);
}else{
var _36=_7.create("nav",null,this.containerNode);
_13.set(_36,"role","navigation");
this._listWrapper.placeAt(_36);
}
...
},addMenuItems:function(_38){
this._cleanDownExistingMenuItems();
dojo.forEach(_38,function(_39,i){
this._addMenuItem(_39,i);
},this);
...
},setSelectedButton:function(_3a){
if(_3a.exceptionButtonFound==null){
_3a.exceptionButtonFound=true;
}
if(this._menuPaneButtonIndexer.getButton(_3a.key)==null&&this._menuPaneButtonIndexer.getSubPagePrimaryPage(_3a.key)==null){
if(_3a.exceptionButtonFound==false){
this._onSelectAfter(_3a);
}else{
throw new Error("No button exists with the requested id : "+_3a.key);
}
}else{
this._buttonSelected(_3a,true);
}
},deselect:function(){
if(this._menuPaneButtonIndexer.selectedButtonDisplayIndex!=-1){
var _3b=this._menuPaneButtonIndexer.getButton(this._menuPaneButtonIndexer.selectedButtonKey);
_3b.button.set("checked",false);
}
},_onSelectBefore:function(_3c){
},_onSelectAfter:function(_3d){
},_addMenuItem:function(_3e,_3f){
_3e=this._filterItem(_3e);
this._generateSubPageIndex(_3e.id,_3e.subPageIds);
var cb=_2.hitch(this,function(_40){
var _41={key:_40.orgID,param:[]};
this._buttonSelected(_41,false);
});
var but=new curam.widget.form.ToggleButtonGroup({label:_3e.label,orgID:_3e.id,groupName:"menuPaneCuramWidget",onClick:function(e){
cb(this);
},baseClass:this._classCurramSideMenuButton,iconClass:this._classCurramSideMenuButtonIcon});
if(_3e.iconPath!=null&&_2.trim(_3e.iconPath).length>0){
_a.set(but.iconNode,{backgroundImage:"url("+_3e.iconPath+")"});
}
if(_3e.selected!=null&&_3e.selected==true){
this._menuPaneButtonIndexer.selectedButtonKey=_3e.id;
}
this._menuPaneButtonIndexer.addNewButton(but,_3e.id);
},_generateSubPageIndex:function(_42,_43){
if(_43!=null&&_43.length>0){
dojo.forEach(_43,function(_44){
if(this._menuPaneButtonIndexer.getSubPagePrimaryPage(_44)==null){
this._menuPaneButtonIndexer.setNewSubPage(_44,_42);
}else{
throw new Error("There has been a clash, sub page has all ready been registered.  Primary ID : "+_42+" Subpage ID : "+_44);
}
},this);
}
},_filterItem:function(_45){
return _45;
},_initaleProcessMenuItems:function(){
var _46=dojo.contentBox(this.domNode);
if(this._showing==false){
_46.w=this._showSize;
}
this._buttonSizerDiv=_7.create("div",{style:{height:_46.h+"px",width:_46.w+"px"}});
...
var _47=this._menuPaneButtonIndexer.getButton(key);
if(_47.button){
this._buttonSizerList.set("item",_47.button.domNode);
var _48=dojo.contentBox(_47.button.domNode);
this._menuPaneButtonIndexer.getButton(key).contextBox=_48;
}
}
...
if(this._previouseHeight!=_4d.h){
