...
<!-- Description -->
<!-- =========== -->
<!-- The included view to display a list of related cases for an issue      -->
<!-- delivery case.                                                         -->
<VIEW
...
>
  ...
  <LIST>
    ...
    <FIELD
      LABEL="Field.Label.RelatedCaseReference"
      WIDTH="25"
    >
      <CONNECT>
        <SOURCE
    ...
    <FIELD
      LABEL="Field.Label.RelatedCaseType"
      WIDTH="30"
    >
      <CONNECT>
        <SOURCE
