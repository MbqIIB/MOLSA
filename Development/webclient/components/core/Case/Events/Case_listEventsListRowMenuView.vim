...
>
  ...
  <ACTION_SET TYPE="LIST_ROW_MENU">
    ...
    <ACTION_CONTROL
      LABEL="ActionControl.Label.EditMeetingMinutesAgenda"
      TYPE="ACTION"
    >
      <CONDITION>
        <IS_TRUE
    ...
    <ACTION_CONTROL
      LABEL="ActionControl.Label.EditMeetingMinutesDecisions"
      TYPE="ACTION"
    >
      <CONDITION>
        <IS_TRUE
    ...
    <ACTION_CONTROL LABEL="ActionControl.Label.Invite">
      <CONDITION>
        <IS_TRUE
          NAME="DISPLAY"
          PROPERTY="organizerIndAndMeetingWithMinutesOpt"
        />
      </CONDITION>
      <LINK
        OPEN_MODAL="true"
    ...
    <ACTION_CONTROL LABEL="ActionControl.Label.RecordMeetingMinutes">
      ...
      >
        ...
        <CONNECT>
          <SOURCE
            NAME="CONSTANT"
            PROPERTY="ListMeetingsForCasePage"
          />
          <TARGET
            NAME="PAGE"
    ...
    >
      <CONDITION>
        <IS_TRUE
          NAME="DISPLAY"
          PROPERTY="editMilestoneFromViewInd"
        />
      </CONDITION>
      <LINK
        OPEN_MODAL="true"
        PAGE_ID="ProductDelivery_modifyMilestoneFromView"
      >
        <CONNECT>
          <SOURCE
            NAME="DISPLAY"
    ...
    >
      <CONDITION>
        <IS_TRUE
          NAME="DISPLAY"
          PROPERTY="editMilestoneFromWaiverInd"
        />
      </CONDITION>
      <LINK
        OPEN_MODAL="true"
        PAGE_ID="ProductDelivery_modifyMilestoneFromViewWaiver"
      >
        <CONNECT>
          <SOURCE
            NAME="DISPLAY"
    ...
    >
      <CONDITION>
        <IS_TRUE
          NAME="DISPLAY"
          PROPERTY="isContractPrinted"
        />
      </CONDITION>
      <LINK
        OPEN_MODAL="true"
        PAGE_ID="ServicePlanDelivery_viewContractHomeDetailsOnly"
      >
        <CONNECT>
          <SOURCE
            NAME="PAGE"
