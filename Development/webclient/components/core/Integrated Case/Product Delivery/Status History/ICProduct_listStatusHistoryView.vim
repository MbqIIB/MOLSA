...
<?curam-deprecated Since Curam 6.0, replaced by ICProduct_listStatusHistoryView1.vim?>
<VIEW
...
>
  ...
  <SERVER_INTERFACE
    ...
    NAME="DISPLAY"
    OPERATION="listProductDeliveryStatusHistory"
  />
  ...
  <MENU MODE="INTEGRATED_CASE">
    <CONNECT>
      <SOURCE
        NAME="DISPLAY"
        PROPERTY="result$icProductDeliveryMenuData$menuData"
      />
    </CONNECT>
  </MENU>
