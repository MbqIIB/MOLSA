...
<!-- delivery. For each component the current delivery pattern is displayed -->
<VIEW
...
>
  ...
  <SERVER_INTERFACE
    ...
    NAME="DISPLAY"
    OPERATION="listProductDeliveryObjectiveAndDelPatt"
    PHASE="DISPLAY"
  />
  ...
  <LIST>
    ...
    <!-- BEGIN, CR00195921, GD -->
    <DETAILS_ROW>
      <INLINE_PAGE PAGE_ID="ProductDelivery_listComponentAssignmentHistoryNoNavigation1">
        <CONNECT>
          <SOURCE
            NAME="PAGE"
            PROPERTY="caseID"
