...
<?curam-deprecated Since Curam 6.0, as part of the Action Plan Enhancement, 
  replaced by Action_createActionView, as the situation details are captured independent of the action.
...
>
  ...
  <SERVER_INTERFACE
    ...
    NAME="ACTION"
    OPERATION="createActionForActionPlan"
    PHASE="ACTION"
  />
