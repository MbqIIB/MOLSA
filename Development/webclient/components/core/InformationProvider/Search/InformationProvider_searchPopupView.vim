...
<!-- for a particular information provider.                      -->
<?curam-deprecated Since Curam 6.0, replaced by InformationProvider_searchPopupView1.vim?>
<VIEW
...
>
  ...
  >
    <FIELD LABEL="Field.Label.ReferenceNumber">
      <CONNECT>
        <TARGET
          NAME="ACTION"
          PROPERTY="infoProviderSearchKey$referenceNumber"
        />
      </CONNECT>
    </FIELD>
    <FIELD LABEL="Field.Label.Name">
      <CONNECT>
        <TARGET
          NAME="ACTION"
          PROPERTY="infoProviderSearchKey$name"
        />
      </CONNECT>
    </FIELD>
    <FIELD LABEL="Field.Label.AddressLineOne">
      <CONNECT>
        <TARGET
          NAME="ACTION"
          PROPERTY="infoProviderSearchKey$address"
        />
      </CONNECT>
    </FIELD>
    <FIELD CONTROL="SKIP"/>
    <FIELD LABEL="Field.Label.City">
      <CONNECT>
        <TARGET
          NAME="ACTION"
          PROPERTY="infoProviderSearchKey$city"
        />
      </CONNECT>
    </FIELD>
  </CLUSTER>
  ...
  >
    ...
    >
      <LINK PAGE_ID="InformationProvider_searchPopup"/>
    </ACTION_CONTROL>
    <ACTION_CONTROL
      IMAGE="CancelButton"
