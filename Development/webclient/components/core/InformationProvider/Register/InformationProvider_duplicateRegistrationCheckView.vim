...
>
  ...
  <INCLUDE FILE_NAME="InformationProvider_searchCriteriaView.vim"/>
  ...
  <CLUSTER>
    ...
    >
      ...
      >
        <LINK PAGE_ID="InformationProvider_duplicateRegistrationCheck"/>
      </ACTION_CONTROL>
    </ACTION_SET>
  </CLUSTER>
  ...
  <LIST TITLE="List.Title.SearchResults">
    ...
    <DETAILS_ROW>
      ...
      <INLINE_PAGE PAGE_ID="InformationProvider_homeTabDetails">
        <CONNECT>
          <SOURCE
            NAME="ACTION"
    ...
    >
      ...
      <LINK PAGE_ID="InformationProvider_home">
        <CONNECT>
          <SOURCE
            NAME="ACTION"
            PROPERTY="dtlsList$concernRoleID"
