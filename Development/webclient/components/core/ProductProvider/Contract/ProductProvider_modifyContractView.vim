...
-->
<!-- Copyright (c) 200-20083 Curam Software Ltd.                                 -->
<!-- All rights reserved.                                                   -->
...
<!-- Description -->
<!-- =========== -->
<!-- The included view for the modify contract pages -->
<VIEW
...
>
  ...
  <SERVER_INTERFACE
    ...
    NAME="DISPLAY"
    OPERATION="readProductProviderContract"
  />
  ...
  <SERVER_INTERFACE
    CLASS="ProductProvider"
    NAME="ACTION"
    OPERATION="modifyProductProviderContract1"
    PHASE="ACTION"
  />
  ...
  <CONNECT>
    ...
    <TARGET
      NAME="ACTION"
      PROPERTY="contractDetails$contractID"
    />
  </CONNECT>
