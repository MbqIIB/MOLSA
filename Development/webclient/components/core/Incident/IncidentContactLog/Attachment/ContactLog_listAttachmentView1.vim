...
<VIEW>
  ...
  <MENU MODE="IN_PAGE_NAVIGATION">
    ...
    >
      <LINK
        PAGE_ID="IncidentContactLog_viewNarrative"
        SAVE_LINK="false"
      >
        <CONNECT>
          <SOURCE
    ...
    <ACTION_CONTROL
      LABEL="ActionControl.Label.MenuContactLog"
      STYLE="in-page-link"
    >
      <LINK
        PAGE_ID="IncidentContactLog_viewContactLog1"
        SAVE_LINK="false"
      >
        <CONNECT>
          <SOURCE
    ...
    >
      <LINK
        PAGE_ID="IncidentContactLog_listAttendee"
        SAVE_LINK="false"
      >
        <CONNECT>
          <SOURCE
    ...
    >
      <LINK
        PAGE_ID="ContactLog_listAttachment1"
        SAVE_LINK="false"
      >
        <CONNECT>
          <SOURCE
      ...
      >
        ...
        >
          ...
          <CONNECT>
            <SOURCE
              NAME="DISPLAY"
              PROPERTY="attachmentLinkDetails$attachmentLinkDtls$versionNo"
            />
            <TARGET
              NAME="PAGE"
              PROPERTY="versionNo"
