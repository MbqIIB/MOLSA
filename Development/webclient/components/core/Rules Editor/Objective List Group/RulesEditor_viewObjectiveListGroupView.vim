...
<!-- Description                                                            -->
<!-- ===========                                                            -->
<!-- Page displaying the details of an objective list group.                -->
<VIEW
...
>
  ...
  <SERVER_INTERFACE
    CLASS="RulesEditor"
    NAME="DISPLAY"
    OPERATION="readObjectiveListGroupSummary"
  />
  <SERVER_INTERFACE
    CLASS="RulesEditor"
    NAME="DISPLAY1"
  ...
  <CONNECT>
    ...
    <TARGET
      NAME="DISPLAY"
      PROPERTY="readSummaryKey$ruleSetID"
    />
  </CONNECT>
  <CONNECT>
    <SOURCE
    ...
    <TARGET
      NAME="DISPLAY"
      PROPERTY="readSummaryKey$nodeID"
    />
  </CONNECT>
  ...
  <LIST TITLE="List.Title.Translations">
    <DETAILS_ROW>
      <INLINE_PAGE PAGE_ID="RulesEditor_viewObjectiveListGroupTranslation">
        <CONNECT>
          <SOURCE
            NAME="PAGE"
            PROPERTY="ruleSetID"
    ...
    <ACTION_SET TYPE="LIST_ROW_MENU">
      <ACTION_CONTROL LABEL="ActionControl.Label.EditTranslation">
        <LINK
          OPEN_MODAL="true"
          PAGE_ID="RulesEditor_modifyObjectiveListGroupTranslation"
        >
          <CONNECT>
            <SOURCE
              NAME="PAGE"
      ...
      <ACTION_CONTROL LABEL="ActionControl.Label.Delete">
        <LINK
          OPEN_MODAL="true"
          PAGE_ID="RulesEditor_cancelObjectiveListGroupTranslation"
        >
          <CONNECT>
            <SOURCE
              NAME="PAGE"
