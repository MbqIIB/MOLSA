...
<!-- Description                                                            -->
<!-- ===========                                                            -->
<!-- Page displaying the details of a rule group.                           -->
<VIEW
...
>
  ...
  <SERVER_INTERFACE
    CLASS="RulesEditor"
    NAME="DISPLAY"
    OPERATION="readRuleGroupSummary"
  />
  <SERVER_INTERFACE
    CLASS="RulesEditor"
    NAME="DISPLAY1"
  ...
  <LIST TITLE="List.Title.Translations">
    <DETAILS_ROW>
      <INLINE_PAGE PAGE_ID="RulesEditor_viewRuleGroupTranslation">
        <CONNECT>
          <SOURCE
            NAME="PAGE"
            PROPERTY="ruleSetID"
    ...
    <ACTION_SET TYPE="LIST_ROW_MENU">      
      ...
      <ACTION_CONTROL LABEL="ActionControl.Label.Delete">
        <LINK
          OPEN_MODAL="true"
          PAGE_ID="RulesEditor_cancelRuleGroupTranslation"
        >
          <CONNECT>
            <SOURCE
              NAME="PAGE"
