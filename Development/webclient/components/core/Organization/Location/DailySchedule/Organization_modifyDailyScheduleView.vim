...
<!-- Description                                                            -->
<!-- ===========                                                            -->
<!-- This process allows the user to modify daily schedule details.         -->
<VIEW
...
>
  ...
  <CONNECT>
    ...
    <TARGET
      NAME="ACTION"
      PROPERTY="dailyScheduleDtls$scheduleID"
    />
  </CONNECT>
  ...
  <CONNECT>
    ...
    <TARGET
      NAME="ACTION"
      PROPERTY="dailyScheduleDtls$versionNo"
    />
  </CONNECT>
