...
>
  ...
  <SERVER_INTERFACE
    CLASS="Product"
    NAME="DISPLAY"
    OPERATION="readPDAssessmentConfiguration"
  />
  ...
  <SERVER_INTERFACE
    CLASS="Product"
    NAME="ACTION"
    OPERATION="modifyPDAssessmentConfiguration"
    PHASE="ACTION"
  />
  ...
  <CONNECT>
    <SOURCE
      NAME="PAGE"
      PROPERTY="pdAssessmentConfigurationID"
    />
    <TARGET
      NAME="DISPLAY"
      PROPERTY="key$key$pdAssessmentConfigurationID"
    />
  </CONNECT>
