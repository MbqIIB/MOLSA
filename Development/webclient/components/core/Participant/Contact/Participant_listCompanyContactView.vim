...
>
  ...
  <ACTION_SET BOTTOM="false">
    ...
    >
      ...
      <LINK
        OPEN_MODAL="true"
        PAGE_ID="Participant_selectCompanyContactType"
      >
        <!-- END, CR00280979 -->
        <CONNECT>
          <SOURCE
  ...
  <LIST>
    ...
    <ACTION_SET TYPE="LIST_ROW_MENU">
      ...
      <ACTION_CONTROL LABEL="ActionControl.Label.Edit">
        ...
        <LINK
          OPEN_MODAL="true"
          PAGE_ID="Participant_resolveModifyContactFromList"
        >
          <CONNECT>
            <SOURCE
              NAME="DISPLAY"
      ...
      >
        <LINK PAGE_ID="Participant_cancelContact">
    ...
    <DETAILS_ROW>
      ...
      <!-- BEGIN, CR00297591, ELG -->
      <INLINE_PAGE PAGE_ID="Participant_viewCompanyContact1">
        <!-- END, CR00297591 -->
        <CONNECT>
          <SOURCE
            NAME="DISPLAY"
    ...
    >
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
          PROPERTY="companyContactTypeCode"
        />
      </CONNECT>
    </FIELD>
