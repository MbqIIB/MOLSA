...
>
  ...
  <CONNECT>
    <SOURCE NAME="PAGE" PROPERTY="concernRoleBankAccountID" />
    <TARGET NAME="DISPLAY" PROPERTY="readConcernRoleBankAcKey$concernRoleBankAccountID" />
  </CONNECT>


  <CLUSTER LABEL_WIDTH="36" NUM_COLS="2" TAB_ORDER="ROW" TITLE="Cluster.Label.Details">
    ...
    <FIELD LABEL="Field.Label.AccountNumber">
      <CONNECT>
        <SOURCE NAME="DISPLAY" PROPERTY="accountNumber" />
      </CONNECT>
    </FIELD>
    ...
    <FIELD LABEL="Field.Label.BankBranchName">
      <CONNECT>
        <SOURCE NAME="DISPLAY" PROPERTY="bankBranchName" />
      </CONNECT>
    </FIELD>
    ...
    <FIELD LABEL="Field.Label.BankName">
      <CONNECT>
        <SOURCE NAME="DISPLAY" PROPERTY="bankName" />
      </CONNECT>
    </FIELD>
    ...
    <FIELD LABEL="Field.Label.Joint">
      <CONNECT>
        <SOURCE NAME="DISPLAY" PROPERTY="jointAccountInd" />
      </CONNECT>
    </FIELD>
    ...
    <FIELD LABEL="Field.Label.Primary">
      <CONNECT>
        <SOURCE NAME="DISPLAY" PROPERTY="primaryBankInd" />
      </CONNECT>
    </FIELD>
    ...
    <FIELD LABEL="Field.Label.AccountStatus">
      <CONNECT>
        <SOURCE NAME="DISPLAY" PROPERTY="bankAccountStatus" />
      </CONNECT>
    </FIELD>
