...
>
  ...
  <CONNECT>
    <SOURCE NAME="PAGE" PROPERTY="concernRoleAlternateID" />
    <TARGET NAME="DISPLAY" PROPERTY="readConcernRoleAltIDKey$concernRoleAlternateID" />
  </CONNECT>
 ...
 <CLUSTER NUM_COLS="2" TITLE="Cluster.Title.Details">
     <FIELD LABEL="Field.Label.AlternateID">
       <CONNECT>
         <SOURCE NAME="DISPLAY" PROPERTY="alternateID" />
       </CONNECT>
     </FIELD>
     ...
     <FIELD LABEL="Field.Label.Primary">
       <CONNECT>
         <SOURCE NAME="DISPLAY" PROPERTY="primaryAlternateInd" />
       </CONNECT>
     </FIELD>
