...
<!-- Description                                                            -->
<!-- ===========                                                            -->
<!-- This page allows the user to view a list of alternate ID's for a       -->
<!-- Participant.                                                           -->
<VIEW
...
>
  ...
  <SERVER_INTERFACE
    ...
    NAME="DISPLAY1"
    OPERATION="listAlternateIDVerificationDetails"
  />
  ...
  <ACTION_SET BOTTOM="false">
    ...
    >
      ...
      <LINK
        OPEN_MODAL="true"
        PAGE_ID="Participant_createAlternateID"
      >
        <CONNECT>
          <SOURCE
            NAME="PAGE"
  ...
  <LIST>
    ...
    <ACTION_SET TYPE="LIST_ROW_MENU">
      <ACTION_CONTROL LABEL="ActionControl.Label.Edit">
        ...
        <LINK
          OPEN_MODAL="true"
          PAGE_ID="Participant_modifyAlternateIDFromList"
        >
          <CONNECT>
            <SOURCE
              NAME="DISPLAY"
      ...
      <ACTION_CONTROL LABEL="ActionControl.Label.Delete">
        <LINK
          OPEN_MODAL="true"
          PAGE_ID="Participant_cancelAlternateID"
        >
          <CONNECT>
            <SOURCE
              NAME="DISPLAY"
    ...
    <DETAILS_ROW>
      ...
      <INLINE_PAGE PAGE_ID="Participant_viewAlternateID">
