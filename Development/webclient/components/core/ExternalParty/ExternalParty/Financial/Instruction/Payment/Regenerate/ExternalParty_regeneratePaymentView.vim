...
<!-- Description -->
<!-- =========== -->
<!-- This page allows the user to regenerate a canceled payment for an      -->
<!-- external party                                                         -->
<?curam-deprecated Since Curam 6.0. Replaced by Financial_regeneratePaymentView.vim. ?>
<VIEW
...
>
  ...
  >
    ...
    >
      <LINK
        PAGE_ID="ExternalParty_viewPaymentInstruction"
        SAVE_LINK="false"
      >
        <CONNECT>
          <SOURCE
    ...
    >
      <LINK PAGE_ID="ExternalParty_resolveCaseForRegenerate">
        <CONNECT>
          <SOURCE
            NAME="PAGE"
            PROPERTY="finInstructionID"
