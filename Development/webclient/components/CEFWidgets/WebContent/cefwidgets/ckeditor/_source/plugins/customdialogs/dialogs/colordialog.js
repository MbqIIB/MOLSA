...
CKEDITOR.tools.extend(CKEDITOR.ibm.dialogs,
{
	colordialog : function(dialogDefinition, editor)
	{
		...
		//if the dialog contains any required fields we must re-add the '* Required' label that was already added in customdialogs/plugin.js
				...
				children: [
					...
					spacer,
					{
						...
						[
							...
							{
								type : 'html',
								html : '<div role="textbox" aria-disabled="true" tabIndex="-1"><span>' + editor.lang.ibm.colordialog.currentColor + '</span>\
							...
							{
								type : 'text',
								label : editor.lang.ibm.colordialog.currentColor,
								...
								onChange : function()
								{
									...
									if(this.getValue()){
										...
										swatch.getParent().setAttribute('aria-label', editor.lang.ibm.colordialog.currentColor +' '+this.getValue());
									} else {
										swatch.removeStyle( 'background-color' );
										swatchText.setHtml( '&nbsp;' );
										swatch.getParent().setAttribute('aria-label', editor.lang.ibm.colordialog.currentColor +' '+ editor.lang.common.notSet);
									}
								}
							},
							requiredLabel
