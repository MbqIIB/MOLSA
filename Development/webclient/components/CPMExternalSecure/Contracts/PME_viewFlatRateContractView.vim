...
<!-- Description -->
<!-- =========== -->
<!-- This page allows the user to view flat-rate contract for a provider.   -->
<VIEW
...
>
  ...
  >
    <FIELD LABEL="Field.Label.TotalContractAmt">
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
          PROPERTY="totalContractAmt"
        />
      </CONNECT>
    </FIELD>
    ...
    <FIELD LABEL="Field.Label.RegularPaymentAmt">
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
          PROPERTY="regularPaymentAmt"
        />
      </CONNECT>
    </FIELD>
  </CLUSTER>
  ...
  <LIST TITLE="List.Title.ProviderOfferings">
    ...
    <FIELD LABEL="Field.Label.POName">
      ...
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
          PROPERTY="viewFlatRateProviderOfferingDetails$name"
        />
      </CONNECT>
    </FIELD>
  </LIST>
