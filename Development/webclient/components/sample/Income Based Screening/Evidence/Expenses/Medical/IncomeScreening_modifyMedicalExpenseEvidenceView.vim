...
<!-- Description -->
<!-- =========== -->
<!-- This page allows the user to modify a medical expense.  -->
<VIEW
...
>
  ...
  <SERVER_INTERFACE
    ...
    NAME="DISPLAY"
    OPERATION="viewMedicalExpenseEvidence"
  />
  ...
  <SERVER_INTERFACE
    CLASS="IncomeScreening"
    NAME="ACTION"
    OPERATION="modifyMedicalExpenseEvidence"
    PHASE="ACTION"
  />
  ...
  >
    ...
    <FIELD LABEL="Field.Label.Type">
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
          PROPERTY="medicalExpenseTypeCode"
        />
      </CONNECT>
      <CONNECT>
        <TARGET
