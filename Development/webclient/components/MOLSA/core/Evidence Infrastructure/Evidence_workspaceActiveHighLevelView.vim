  ...
  <LIST>
    ...
    >
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
          PROPERTY="result$activeEvdInstanceDtlsList$dtls$evdInstDtls$evidenceType"
        />
      </CONNECT>
    ...
    >
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
          PROPERTY="result$activeEvdInstanceDtlsList$dtls$evdInstDtls$summary"
        />
      </CONNECT>
      <LINK PAGE_ID="Evidence_resolveObjectFromMetaData">
        <CONNECT>
          <SOURCE
            NAME="DISPLAY"
            PROPERTY="result$activeEvdInstanceDtlsList$dtls$evdInstDtls$successionID"
          />
          <TARGET
            NAME="PAGE"
