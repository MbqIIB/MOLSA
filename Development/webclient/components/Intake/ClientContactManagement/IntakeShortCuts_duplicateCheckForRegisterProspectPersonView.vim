...
>
  ...
  >
    ...
    >
      ...
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
          PROPERTY="result$searchKey$dateOfBirth"
        />
      </CONNECT>
      <!--END, CR00297753 -->
      <CONNECT>
  ...
  <CLUSTER>
    ...
    >
      ...
      >
        <LINK
          PAGE_ID="AddProspectPersonWizard_duplicateCheck"
          SAVE_LINK="false"
        >
          <CONNECT>
            <SOURCE
    ...
    >
      ...
      >
        <CONNECT>
          <SOURCE
            NAME="ACTION"
            PROPERTY="result$searchResult$personSearchResult$dtlsList$concernRoleID"
          />
          <TARGET
            NAME="PAGE"
