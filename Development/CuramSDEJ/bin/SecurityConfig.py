...
def configGlobalSecurity (  ):
        ...
        new_property.append(["value", "true"])
...
#endDef 
# Add Cúram specific login modules
...
# Disable the HttpOnly attribute on JSESSIONID
def configHTTPOnlyCookieAttr (  ):
        global AdminConfig, cookieName, cookieMaxAge, cookieDomain 
        global cookiePath, cookieSecure, cookieHttpOnly, cookieUseContextRootAsPath

        print "Disabling the HTTPOnly attibute on JSESSIONID cookie"
        ...
        try:
                ...
                attrib.append(["secure", cookieSecure])
        except:
                print "secure - attribute not available for cookie in this version of Websphere and is therefore not required."
        try:
                AdminConfig.showAttribute(jsessionId, "httpOnly")
                attrib.append(["httpOnly", cookieHttpOnly])
        except:
                print "httpOnly - attribute not available for cookie in this version of Websphere and is therefore not required."
