  ...
  <xsl:template match="STRUCT">
    <fo:root>
      <fo:layout-master-set>
        <fo:simple-page-master master-name="only" page-height="297mm" page-width="210mm" margin-top="50mm" margin-bottom="25mm" margin-left="30mm" margin-right="30mm">
          <fo:region-body />
	...
	<xsl:apply-templates select="./FIELD[FNAME='dtls']/STRUCT[SNAME='ProFormaDocumentData']/FIELD[FNAME='concernRoleName']"/> 
        ...
        <fo:block xsl:use-attribute-sets="Normal_5"> بطلب للحصول على مساعدة اجتماعية و سبب طلب المساعدة العجز </fo:block>
