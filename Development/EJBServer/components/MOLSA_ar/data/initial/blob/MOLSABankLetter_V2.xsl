  ...
  <xsl:template match="STRUCT">
    <fo:root>
      <fo:layout-master-set>
        <fo:simple-page-master master-name="only" page-height="297mm" page-width="210mm" margin-top="70mm" margin-bottom="30mm" margin-left="30mm" margin-right="30mm">
          <fo:region-body />
	...
	<fo:block xsl:use-attribute-sets="Normal_1" >  السيـــد مدير بنك / <xsl:apply-templates select="FIELD[FNAME='bankName']"/>       المحترم     </fo:block>
	<!--<fo:block xsl:use-attribute-sets="Normal_1">   المحترم               </fo:block> -->
	...
	<fo:block xsl:use-attribute-sets="Normal_6" font-weight="bold"> والسلام عليكم و رحمة الله و بركاته ...</fo:block>
