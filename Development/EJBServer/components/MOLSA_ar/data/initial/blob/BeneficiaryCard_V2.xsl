        ...
        <fo:layout-master-set>
            <fo:simple-page-master master-name="A4" page-width="85.6mm"
              ...
              >
                ...
                <fo:region-after region-name="xsl-region-after" extent=".10in"/>
        ...
        <fo:page-sequence master-reference="A4">
            ...
            <fo:static-content flow-name="xsl-region-after" margin-bottom="0mm">
                <fo:block font-size="0pt" line-height="0mm" margin-bottom="0mm" >
                    ...
                    <fo:external-graphic src="images/footer.png" content-width="scale-to-fit" content-height="100%" width="100%"/>
                </fo:block>
            ...
            <fo:flow flow-name="xsl-region-body"  font-family="Times New Roman" >
                <fo:block background-color="rgb(255,229,78)" font-size="0pt" line-height="0mm">
                    <fo:external-graphic src="MOLSA/molsa_beneficiary_logo.png"  content-width="scale-to-fit" content-height="100%" width="100%"/>
                </fo:block>
                
                <fo:block   font-size="10pt"   text-align="right" margin-left="5mm" margin-right="5mm" margin-top="0mm" >
                ...
                <fo:block  border-color="black"  font-size="6pt"    text-align="right" margin-top="1mm" margin-left="5mm" margin-right="5mm" border-style="solid" border-width="0.2mm" padding-left="2mm" padding-right="2mm" padding-top="2mm" padding-bottom="1mm">
				 ...
				 <fo:block    font-size="5pt"    text-align="right" border-top-style="solid" border-top-color="rgb(157,33,65)" margin-top="1mm" padding-top="1mm">                  
                </fo:block>
                <fo:block    font-size="5pt"    text-align="right"  margin-top="1mm" padding-top="1mm" margin-right="3mm">
