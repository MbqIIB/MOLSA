...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:foa="http://fabio" version="1.0">
 ...
 <xsl:attribute-set name="Normal_3" foa:class="block">
  ...
  <xsl:template match="STRUCT">
	...
	<fo:block xsl:use-attribute-sets="Normal_1" >السيـــد مدير بنك / <xsl:apply-templates select="FIELD[FNAME='bankName']"/> <fo:leader leader-length="20mm"/> المحترم</fo:block>
	...
	<fo:block xsl:use-attribute-sets="Normal_10"><xsl:apply-templates select="FIELD[FNAME='molsaManagerName']"/></fo:block>
