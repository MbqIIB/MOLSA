              ...
              <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                <fo:block text-align="justify">
                  ...
                  <fo:inline font-size="12pt">
                    نود اعلامك بأنه قد تم ادراجك كجهة تقديم لهيئتنا
 بموجب رقم المرجع، <xsl:apply-templates select="FIELD[FNAME='providerRefNumber']" /> بدءا من <xsl:apply-templates select="FIELD[FNAME='providerEnrollDate']" />. ويعد اعتمادك لتقديم الخدمات الى عملاء هذه الهيئة معلق
                     لاتمام عمليات التحقق والتدقيق المطلوبة بنجاح.
                  </fo:inline>
                  <fo:block>
                    <fo:leader leader-pattern="space" />
                  </fo:block>
