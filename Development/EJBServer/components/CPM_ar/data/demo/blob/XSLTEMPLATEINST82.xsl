              ...
              <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                <fo:block text-align="justify">
                  ...
                  <fo:inline font-size="12pt">
                    نريد اعلامك بأنه قد تم تعليق الترخيص الخاص بك اعتبارا من <xsl:apply-templates select="FIELD[FNAME='eventDate']" />. وقد
تم تعليق الترخيص الخاص بك للسبب التالي: <xsl:apply-templates select="FIELD[FNAME='suspensionReason']" />.
                  </fo:inline>
                  <fo:block>
                    <fo:leader leader-pattern="space" />
                  </fo:block>
