            ...
            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
              ...
              <xsl:apply-templates select="FIELD[FNAME='organizationName']" />
                  ...
                  <fo:inline font-size="12pt">
                    ...
                    وافق على قيام جهات التقديم التالية على تقديم الخدمات الموضحة بأسفل من <xsl:apply-templates select="FIELD[FNAME='startDate']" />
                    الى <xsl:apply-templates select="FIELD[FNAME='endDate']" />
                    بالسعر الثابت <xsl:apply-templates select="FIELD[FNAME='regularPaymentAmount']" />
                    (
