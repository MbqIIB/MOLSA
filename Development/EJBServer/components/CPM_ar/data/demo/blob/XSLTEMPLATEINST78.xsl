              ...
              <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                <fo:block text-align="justify">
                  ...
                  <fo:inline font-size="12pt">
                    نود اعلامك بأنك قد تم اعتمادك لتقديم <xsl:apply-templates select="FIELD[FNAME='serviceOfferingName']"
                    /> لعملاء هذه الهيئة بدءا من <xsl:apply-templates select="FIELD[FNAME='providerOffStartDate']" />.
                  </fo:inline>
                  <fo:block>
                    <fo:leader leader-pattern="space" />
                  </fo:block>
