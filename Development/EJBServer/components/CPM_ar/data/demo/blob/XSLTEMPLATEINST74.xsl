              ...
              <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                <fo:block text-align="justify">
                  ...
                  <fo:inline font-size="12pt" font-weight="normal">
                    عزيزي <xsl:apply-templates select="FIELD[FNAME='providerGrpName']" />
                    ,
                  </fo:inline>
                  <fo:block>
                    <fo:leader leader-pattern="space" />
                  ...
                  <fo:inline font-size="12pt">
                    نود اعلامك بأنه قد تم ادراجك كمجموعة جهة تقديم لهيئتنا
 بموجب رقم المرجع، <xsl:apply-templates select="FIELD[FNAME='providerGrpRefNumber']" /> بدءا من
<xsl:apply-templates select="FIELD[FNAME='providerGrpEnrollDate']" />.
                  </fo:inline>
                  <fo:block>
                    <fo:leader leader-pattern="space" />
                  </fo:block>
