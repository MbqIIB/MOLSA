            ...
            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
              ...
              <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                <fo:block text-align="justify">
                  ...
                  <fo:inline font-size="12pt">مرفق طيه عقدك مع هيئتنا لتقديم الخدمات لعملائنا.
                    برجاء قراءة وتوقيع العقد واعادته لنا باستخدام المظروف المرفق المدفوع مسبقا.</fo:inline>
                  <fo:block>
                    <fo:leader leader-pattern="space" />
                  </fo:block>
                  <fo:block>
