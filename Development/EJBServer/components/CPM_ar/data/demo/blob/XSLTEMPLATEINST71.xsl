              ...
              <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                <fo:block text-align="justify">
                  ...
                  <fo:inline font-size="12pt">
                    نود اعلامك بأنك لم تعد جهة تقديم فعالة لهيئتنا
 بموجب رقم المرجع، <xsl:apply-templates select="FIELD[FNAME='providerRefNumber']" /> بدءا من <xsl:apply-templates select="FIELD[FNAME='providerEndDate']" />.
                  </fo:inline>
                  <fo:block>
                    <fo:leader leader-pattern="space" />
                  </fo:block>
