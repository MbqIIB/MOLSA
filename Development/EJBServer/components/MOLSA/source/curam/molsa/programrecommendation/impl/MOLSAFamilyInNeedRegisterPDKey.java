...
/**
 * Contains processing to Register a product delivery key for a FAmily in Need
 * Program if eligible member are more than one we calculate age and create a
 * product delivery for senior citizen
 * 
 */
public class MOLSAFamilyInNeedRegisterPDKey implements
	 ...
	 * Constructor.
	 */
	public MOLSAFamilyInNeedRegisterPDKey() {

		GuiceWrapper.getInjector().injectMembers(this);
	//	evidenceControllerObj = (EvidenceController) EvidenceControllerFactory
		//		.newInstance();
