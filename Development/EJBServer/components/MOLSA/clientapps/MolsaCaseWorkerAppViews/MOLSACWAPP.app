...
<ac:application xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
 ...
 id="MOLSACWAPP"
 logo="MOLSACWAPP.logo"
 title="MOLSACWAPP.title"
 subtitle="MOLSACWAPP.subtitle"
 user-message="MOLSACWAPP.UserMessage">
 ...
 <ac:application-search default-search-page="Intake_resolveQuickSearch" initial-text="Application.Search.InitialText"/>
  ...
  <ac:section-ref id="MOLSACWAPPHomeSection"/>
  <ac:section-ref id="MOLSACWAPPWorkspaceSection"/>
