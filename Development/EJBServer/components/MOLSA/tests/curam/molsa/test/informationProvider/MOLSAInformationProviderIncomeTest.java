...
public class MOLSAInformationProviderIncomeTest extends CERScenarioTestBase {
	


	public MOLSAInformationProviderIncomeTest(String arg0) {
		super(arg0);
	...
	protected void addEvidence(CaseKey caseKey) throws AppException,
		...
		createEducationEvidence(caseKey, participantid, caseParticipantRoleID, Date.fromISO8601("20000101") , EDUCATION.ENROLLED, EDUCATIONLEVEL.PRIMARY);
		createIncomeEvidence(caseKey, participantid, caseParticipantRoleID, Date.fromISO8601("20050101"), FREQUENCYCODE.MONTHLY, INCOMETYPECODE.COMMERCIAL, 100); 
	...
	protected void preAssertionOnCase(CaseKey caseKey) throws AppException,
		...
		details.type = RESPONSETYPE.GOVERNMENTEMPLOYMENT;
		details.amount = 1000;
		...
		curam.core.facade.infrastructure.struct.ListAllEvidenceDtls list2 = test2.listAllEvidence(caseKey1);
		 assertEquals(5, list2.evidenceParticipantDtlsList.dtls.size());
	}
