...
/**
 * 
 * Tests update feature on MOI.
 * 
 */
public class MOLSAMoiUpdateTest extends CERScenarioTestBase {
	 ...
	 *            String
	 */
	public MOLSAMoiUpdateTest(String arg0) {
		super(arg0);
	}
	...
	protected void preAssertionOnCase(CaseKey caseKey) throws AppException,
		...
		concernRoleID.concernRoleID = caseHeader.getConcernRole().getID();
		curam.molsa.moi.facade.intf.MOLSAMoi molsaMoi = curam.molsa.moi.facade.fact.MOLSAMoiFactory
				.newInstance();
		MOLSAMoiDtls moiDtls = new MOLSAMoiDtls();
		moiDtls.qid = "12345678901";
		moiDtls.sexCode = 1;
