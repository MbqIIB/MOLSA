...
public class MOLSASeniorCitizenEligibilityCalculatorTest extends
	...
	/**
	 * Test case for 'ismarriedTimeline' attribute. Test Data:gender as single
	...
	public void testisMarriedTimeline() {
		...
		MemberCPRCalculator memberCPRCalculator = MemberCPRCalculator_Factory
				.getFactory().newInstance(getSession(), caseParticipantRole);
		memberCPRCalculator.isMarriedTimeline().specifyValue(
				Timeline.TRUE_FOREVER);

		CREOLETestHelper.assertEquals(Timeline.TRUE_FOREVER, seniorCitizenObj
				.isMarriedTimeline().getValue());
	}

	/**
	 * Test case for 'isFemaleTimeline' attribute. Test Data:Gender specified as
	 * female/male and tested Test Class : SeniorCitizenCPRCalculator
	 */
	...
	public void testisFemaleTimeline1() {
		...
		CREOLETestHelper.assertEquals(Timeline.FALSE_FOREVER, seniorCitizenObj
				.isFemaleTimeline().getValue());
	}

	/**
	 * Test case for 'IsAgeBelowSixtyTimeline' attribute. Test Data:DOB Test
	 * Class : SeniorCitizenCPRCalculator
	 */

	/**
	 * Test case for 'UnearnedIncomeAmount' attribute. Test Data:Income type and
	 * Income amount Test Class : SeniorCitizenEligibilityUnitCalculator
	 */
	 ...
	 * SeniorCitizenEligibilityUnitCalculator
	 */
	...
	public void testhasHouseholdPassedIncomeTestTimeline() {
		...
		seniorEligibilityUnitCalculatorObj.primaryBeneficiaryAmount()
				.specifyValue(amount2Timeline);
		CREOLETestHelper.assertEquals(resultTimeline,
				seniorEligibilityUnitCalculatorObj
	...
	public void testtotalCountableIncomeTimeline() {
		...
		final SeniorCitizenEligibilityUnitCalculator seniorEligibilityUnitCalculatorObj = SeniorCitizenEligibilityUnitCalculator_Factory
				.getFactory().newInstance(getSession(), caseID,
						saHouseholdUnitCalculator);
		seniorEligibilityUnitCalculatorObj.caseID().specifyValue(caseID);
		seniorEligibilityUnitCalculatorObj.unearnedIncomeAmount().specifyValue(
				amountTimeline);
		seniorEligibilityUnitCalculatorObj.totalExpenseAmountTimeline()
				.specifyValue(amount2Timeline);
	...
	/**
	 * Test case for 'totalExpenseAmountTimeline' attribute. Test Data: Test
	 * Class : SeniorCitizenEligibilityUnitCalculator
	 */
	...
	public void testTotalExpenseAmountTimeline1() {
		...
		seniorEligibilityUnitCalculatorObj.caseID().specifyValue(
	...
	public void testMonthlyAmountTimeline() {
		...
		CREOLETestHelper.assertEquals(outputTimeline,
				seniorEligibilityUnitCalculatorObj.monthlyAmountTimeline()
						.getValue());
	}
	...
	/**
	 * Test case for 'primaryBeneficiaryAmount' attribute. Test Data: Test Class
	 * : SeniorCitizenEligibilityUnitCalculator
	 */
	/*
	 * public void testPrimaryBeneficiaryAmount(){ final Number caseID = 1111L;
	 * final List<CaseParticipantRole> caseParticipantRoleList =
	 ...
	 * SAHouseholdUnitCalculator_Factory
	 * .getFactory().newInstance(getSession());
	 * saHouseholdUnitCalculator.mandatoryMembers().specifyValue(
	 * saHouseholdUnitMemberList); final SeniorCitizenEligibilityUnitCalculator
	 * seniorEligibilityUnitCalculatorObj =
	 * SeniorCitizenEligibilityUnitCalculator_Factory
	 * .getFactory().newInstance(getSession(), caseID,
	 * saHouseholdUnitCalculator);
	 * 
	 * final List<Interval<Number>> amount = new ArrayList<Interval<Number>>();
	 * amount.add(new Interval<Number>(null, 0)); amount.add(new
	 * Interval<Number>(Date.fromISO8601("20040601"), 6000)); final
	 * Timeline<Number> amountTimeline = new Timeline<Number>(amount);
	 * 
	 * final List<Interval<Number>> output = new ArrayList<Interval<Number>>();
	 * output.add(new Interval<Number>(null, 0)); output.add(new
	 * Interval<Number>(Date.fromISO8601("20040601"), 6000)); final
	 * Timeline<Number> outputTimeline = new Timeline<Number>(output);
	 * 
	 * 
	 * AmountCalculator test =
	 * AmountCalculator_Factory.getFactory().newInstance(getSession(),
	 * caseParticipantRoleList.get(0), caseParticipantRoleList);
	 * test.amountList().specifyValue(amountTimeline);
	 * 
	 * HeadOfHouse hh =
	 * HeadOfHouse_Factory.getFactory().newInstance(getSession());
	 * hh.caseID().specifyValue(caseID);
	 * hh.participant().specifyValue(caseParticipantRoleList
	 * .get(0).caseParticipantRoleID().getValue());
	 * 
	 * //
	 * seniorEligibilityUnitCalculatorObj.primaryBeneficiaryAmount().specifyValue
	 * (test); seniorEligibilityUnitCalculatorObj.caseID().specifyValue(caseID);
	 * seniorEligibilityUnitCalculatorObj
	 * .headOfHouseholdRecord().specifyValue(hh);
	 * 
	 * CREOLETestHelper.assertEquals(outputTimeline,
	 * seniorEligibilityUnitCalculatorObj
	 * .primaryBeneficiaryAmount().getValue()); }
	 */
