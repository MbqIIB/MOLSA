...
public class AnonymousParents002Test extends CERScenarioTestBase {
	...
	public AnonymousParents002Test(String arg0) {
		super(arg0);
	...
	protected void addEvidence(CaseKey caseKey) throws AppException,
		...
		createHouseholdRelationshipEvidence(caseKey,
		 ...
		 createAnonymousParentsEvidence(caseKey, participantid, caseParticipantRoleID, getDate(1,1,2013), true);
		    createAnonymousParentsEvidence(caseKey, siblingparticipantid, siblingcaseParticipantRoleID, getDate(1,1,2013), true);
...
householdUnitList.add(householdUnit1);*/
	...
	/**
	  ...
	  protected void performCOC(final CaseKey caseKey) throws AppException, InformationalException {
	    ...
	    createHouseholdMemberEvidence(caseKey, participantid, caseParticipantRoleID, currentDate, CITIZENSHIPCODE.QATARI, RESIDENCY.YES);
