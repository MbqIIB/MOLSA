...
MOLSACreoleBaseTest{
	...
	public void testisSingleTimeline1(){
	   ...
	   /**
	   * Test case for 'isHavingAnonymousFather' attribute. 
	   * Test Data:absent father as Anonymous
	   * Test Class : AnonymousParentsCPRCalculator
	   */
	...
	public void testisHavingAnonymousFather() {
		...
		final List<Interval<CodeTableItem>> test1 = new ArrayList<Interval<CodeTableItem>>();
		test1.add(new Interval<CodeTableItem>(null, new CodeTableItem(ABSENTFATHER.TABLENAME, ABSENTFATHER.ANONYMOUS)));
		final Timeline<CodeTableItem> absenceTimeline = new Timeline<CodeTableItem>(test1);
		...
		AbsentFather test = AbsentFather_Factory.getFactory().newInstance(getSession());
		...
		/*ChildrenOfAbsentFather childrenOfAbsentFather = ChildrenOfAbsentFather_Factory.getFactory().newInstance(getSession());
		childrenOfAbsentFather.caseID().specifyValue(caseID);
		childrenOfAbsentFather.absentFather().specifyValue(test);
		childrenOfAbsentFather.participant().specifyValue(caseParticipantRoleList.get(0).caseParticipantRoleID().getValue());*/
		
		MemberCPRCalculator memberCPRCalculator = MemberCPRCalculator_Factory.getFactory().newInstance(getSession(), caseParticipantRoleList.get(0));
		memberCPRCalculator.absentFatherRecords().specifyValue(absentList);
	/*	memberCPRCalculator.isChildofAbsentFatherTimeline().specifyValue(Timeline.TRUE_FOREVER);*/
		final AnonymousParentsCPRCalculator anonymousParentsCPRCalculatorObj = AnonymousParentsCPRCalculator_Factory
		.getFactory().newInstance(getSession(), caseParticipantRoleList.get(0));
		
		CREOLETestHelper.assertEquals(firstTimeline,anonymousParentsCPRCalculatorObj.isHavingAnonymousFather()
				.getValue());
	}
...
public void testisHavingAnonymousFather1() {
		...
		final List<Interval<CodeTableItem>> test1 = new ArrayList<Interval<CodeTableItem>>();
		test1.add(new Interval<CodeTableItem>(null, new CodeTableItem(ABSENTFATHER.TABLENAME, ABSENTFATHER.DECEASED)));
		final Timeline<CodeTableItem> absenceTimeline = new Timeline<CodeTableItem>(test1);
	   ...
	   /**
	   * Test case for 'isAnonymousParentsTimeline' attribute. 
	   * Test Data: Three conditions
	   * Test Class : AnonymousParentsCPRCalculator
	   */
	...
	public void testisAnonymousParentsTimeline() {
		 ...
		 final AnonymousParentsCPRCalculator anonymousParentsCPRCalculatorObj = AnonymousParentsCPRCalculator_Factory
			.getFactory().newInstance(getSession(), caseParticipantRoleList.get(0));
		 anonymousParentsCPRCalculatorObj.isHavingAnonymousFather().specifyValue(Timeline.TRUE_FOREVER);
		 anonymousParentsCPRCalculatorObj.isSingleTimeline().specifyValue(Timeline.TRUE_FOREVER);
		 anonymousParentsCPRCalculatorObj.isAgeBelowSixtyTimeline().specifyValue(Timeline.TRUE_FOREVER);
		 
	     CREOLETestHelper.assertEquals(Timeline.TRUE_FOREVER,anonymousParentsCPRCalculatorObj.isAnonymousParentsTimeline()
					.getValue());
	 }
	 ...
	 /**
	   ...
	   * Test Class : AnonymousParentsEligibilityUnitCalculator
	   */
	...
	public void testisEligibleTimeline() {
		...
		anonymousParentsCalculatorCalculatorObj.hasHouseholdPassedIncomeTestTimeline().specifyValue(fourthTimeline);
		...
		CREOLETestHelper.assertEquals(firstTimeline,
				anonymousParentsCalculatorCalculatorObj.isEligibleTimeline().getValue());
	}
	...
	public void testUnearnedIncomeAmount(){
		...
		CREOLETestHelper.assertEquals(amountTimeline,
				anonymousParentsCalculatorCalculatorObj.unearnedIncomeAmount().getValue());
	}
	...
	*/
	...
	public void testTotalExpenseAmountTimeline(){
		...
		CREOLETestHelper.assertEquals(amountTimeline,
				anonymousParentsCalculatorCalculatorObj.totalExpenseAmountTimeline().getValue());
	}
	...
	*/
    ...
    // When unearned income is greater than total expense amount
		...
		anonymousParentsCalculatorCalculatorObj.totalExpenseAmountTimeline().specifyValue(amount2Timeline);
		...
		CREOLETestHelper.assertEquals(outputTimeline,
				anonymousParentsCalculatorCalculatorObj.totalCountableIncomeTimeline().getValue());
	}
	...
	public void testMonthlyAmountTimeline(){
		...
		anonymousParentsCalculatorCalculatorObj.totalCountableIncomeTimeline()
				.specifyValue(amountTimeline);
		CREOLETestHelper.assertEquals(outputTimeline,
				anonymousParentsCalculatorCalculatorObj.monthlyAmountTimeline().getValue());
	}
	...
	public void testMonthlyAmountTimeline1(){
	 ...
	 /**
	   ...
	   * Test Class: WidowHouseholdComposition
	   */
