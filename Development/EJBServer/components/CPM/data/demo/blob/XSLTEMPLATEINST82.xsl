              ...
              <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                <fo:block text-align="justify">
                  ...
                  <fo:inline font-size="12pt">
                    We wish to inform you that your license has been suspended with effect from
                    <xsl:apply-templates select="FIELD[FNAME='eventDate']" />
                    . Your
                       license has been suspended for the following reason:
                    <xsl:apply-templates select="FIELD[FNAME='suspensionReason']" />
                    .
                  </fo:inline>
                  <fo:block>
                    <fo:leader leader-pattern="space" />
