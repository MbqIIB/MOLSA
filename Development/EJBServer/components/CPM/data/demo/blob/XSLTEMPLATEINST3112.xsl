              ...
              <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                <fo:block text-align="justify">
                  ...
                  <fo:inline font-size="12pt">
                    We wish to inform you that as a result of a correction to roster line item
                    <xsl:apply-templates select="FIELD[FNAME='rosterLineItemReferenceNo']" />
                    from attendance roster
                    <xsl:apply-templates select="FIELD[FNAME='rosterReferenceNo']" />
                    submitted on
                    <xsl:apply-templates select="FIELD[FNAME='receiptDate']" />
                    for the delivery of
                    <xsl:apply-templates select="FIELD[FNAME='serviceOfferingName']" />
                    , an underpayment was detected, and as a result you will be issued a payment as part of your next issued payment to account for the underpayment in the amount of
