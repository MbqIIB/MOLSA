    ...
    <fo:root>
      ...
      <fo:page-sequence master-reference="only">
        ...
        <fo:flow flow-name="xsl-region-body" font-family="WT Sans ME">
          ...
          <!-- Dear .. -->
          <fo:block xsl:use-attribute-sets="Normal_1">
            عزيزي <xsl:apply-templates select="./FIELD[FNAME='externalPartyDtls']/STRUCT[SNAME='ConcernNameAlternateIDRegDate']/FIELD[FNAME='concernRoleName']" />
            ,
          </fo:block>
          ...
          <!-- Main body -->
          <fo:block xsl:use-attribute-sets="Normal_1">
            تريد اعلامك بأنه قد تم تسجيلك كطرف خارجي مع هيئتنا بموجب رقم المرجع،
