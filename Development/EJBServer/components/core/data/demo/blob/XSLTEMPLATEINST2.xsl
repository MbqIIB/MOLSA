      ...
      <fo:page-sequence master-reference="only">
        ...
        <fo:flow flow-name="xsl-region-body" font-family="WT Sans">
          ...
          <fo:block xsl:use-attribute-sets="Normal_5">
            ...
            ,
            has been reactivated on
            <xsl:apply-templates select="FIELD[FNAME='caseReactivationDate']" />
            for the following reason -
            <xsl:apply-templates select="FIELD[FNAME='caseReactivationReason']" />
            .
          </fo:block>
          <fo:block xsl:use-attribute-sets="Normal_4"> </fo:block>
          <fo:block xsl:use-attribute-sets="Normal_5">Sincerely,</fo:block>
          <fo:block xsl:use-attribute-sets="Normal_4"> </fo:block>
          <fo:block xsl:use-attribute-sets="Normal_6">
