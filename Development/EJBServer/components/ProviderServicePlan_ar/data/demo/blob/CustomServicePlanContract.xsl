...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
  ...
  <xsl:template match="STRUCT[SNAME='ServicePlanContractDetails']">
    <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="center" text-indent="0.0pt">
      <fo:inline font-size="12pt" font-weight="bold">عقد خطة الخدمة</fo:inline>
    </fo:block>
    ...
    <fo:block wrap-option="wrap" margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
      <fo:inline font-size="8pt">
        اسم العميل: <xsl:apply-templates select="FIELD[FNAME='clientName']" />
      </fo:inline>
      <fo:inline font-size="8pt">
    ...
    <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
      <fo:inline font-size="8pt">
        تاريخ العقد: <xsl:apply-templates select="FIELD[FNAME='contractDate']" />
      </fo:inline>
      <fo:inline font-size="8pt">
                         رقم مرجع الخطة:
    ...
    <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
      <fo:inline font-size="8pt">
        هدف الخطة: <xsl:apply-templates select="FIELD[FNAME='plannedGoalName']" />
      </fo:inline>
    </fo:block>
    <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
      <fo:inline font-size="8pt">
    ...
    <xsl:if test="count(FIELD[FNAME='objectivePlannedSubGoalDetails']/STRUCT[SNAME='ObjectivePlannedSubGoalDetails']/FIELD[FNAME='plannedSubGoalDetails']/STRUCT_LIST/STRUCT) &gt; 0">
      ...
      <fo:block font-size="10.0pt" font-weight="bold" border="1px solid blue" background-color="white" text-align="center">الغايات</fo:block>
    ...
    <xsl:if test="count(FIELD[FNAME='barrierPlannedSubGoalDetails']/STRUCT[SNAME='BarrierPlannedSubGoalDetails']/FIELD[FNAME='plannedSubGoalDetails']/STRUCT_LIST/STRUCT) &gt; 0">
      <fo:block font-size="8.0pt" margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt"> </fo:block>
      <fo:block font-size="10.0pt" font-weight="bold" border="1px solid blue" background-color="white" text-align="center">الحواجز</fo:block>
      <fo:block font-size="5.0pt" margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt"> </fo:block>
    ...
    <xsl:if test="count(FIELD[FNAME='needPlannedSubGoalDetails']/STRUCT[SNAME='NeedPlannedSubGoalDetails']/FIELD[FNAME='plannedSubGoalDetails']/STRUCT_LIST/STRUCT) &gt; 0">
      <fo:block font-size="8.0pt" margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt"> </fo:block>
      <fo:block font-size="10.0pt" font-weight="bold" border="1px solid blue" background-color="white" text-align="center">الاحتياجات</fo:block>
      <fo:block font-size="5.0pt" margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt"> </fo:block>
  ...
  <xsl:template match="STRUCT[SNAME='ConcernRoleNameDetails']">
    <fo:table-row>
      <fo:table-cell border-bottom-width="0.5pt" padding-left="5.4pt" padding-right="5.4pt">
        <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
          <fo:inline font-size="8pt">التوقيع:___________________________</fo:inline>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell border-bottom-width="0.5pt" padding-left="5.4pt" padding-right="5.4pt">
        <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="end" text-indent="0.0pt">
          <fo:inline font-size="8pt">التاريخ:____________________</fo:inline>
        </fo:block>
      </fo:table-cell>
    </fo:table-row>
    <fo:table-row>
  ...
  <xsl:template match="STRUCT[SNAME='PlannedItemDetailsForContract']">
    <fo:table-row>
      <fo:table-cell padding-left="2.4pt" padding-right="2.4pt" number-columns-spanned="2">
        ...
        <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
          <fo:inline font-size="8pt">
            بند الخطة: <xsl:apply-templates select="FIELD[FNAME='plannedItemName']" />
          </fo:inline>
        </fo:block>
        <fo:block font-size="8.0pt" margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt"> </fo:block>
      </fo:table-cell>
    ...
    <fo:table-row>
      <fo:table-cell padding-left="2.4pt" padding-right="2.4pt">
        <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
          <fo:inline font-size="8pt">
            تاريخ البدء: <xsl:apply-templates select="FIELD[FNAME='plannedItemExpectedStartDate']" />
          </fo:inline>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell padding-left="2.4pt" padding-right="2.4pt">
        <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
          <fo:inline font-size="8pt">
            تاريخ الانتهاء: <xsl:apply-templates select="FIELD[FNAME='plannedItemExpectedEndDate']" />
          </fo:inline>
        </fo:block>
      </fo:table-cell>
    </fo:table-row>
    <xsl:if test="FIELD[FNAME='authorizedUnits']/VALUE &gt; 0">
      <fo:table-row>
        <fo:table-cell padding-left="2.4pt" padding-right="2.4pt">
          <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
            <fo:inline font-size="8pt">
              عروض الخدمة: <xsl:apply-templates select="FIELD[FNAME='serviceOfferingName']" />
            </fo:inline>
          </fo:block>
        </fo:table-cell>
        <fo:table-cell padding-left="2.4pt" padding-right="2.4pt">
          <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
            <fo:inline font-size="8pt">
              جهة التقديم: <xsl:apply-templates select="FIELD[FNAME='providerName']" />
            </fo:inline>
          </fo:block>
        </fo:table-cell>
      </fo:table-row>
      <fo:table-row>
        <fo:table-cell padding-left="2.4pt" padding-right="2.4pt">
          <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
            <fo:inline font-size="8pt">
              الوحدات المصرح بها: <xsl:apply-templates select="FIELD[FNAME='authorizedUnits']" />
            </fo:inline>
          </fo:block>
        </fo:table-cell>
        <fo:table-cell padding-left="2.4pt" padding-right="2.4pt">
          <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
            <fo:inline font-size="8pt">
              اجمالي الوحدات المصرح بها: <xsl:apply-templates select="FIELD[FNAME='totalUnitsAuthorized']" />
            </fo:inline>
          </fo:block>
        </fo:table-cell>
      </fo:table-row>
      <fo:table-row>
        <fo:table-cell padding-left="2.4pt" padding-right="2.4pt">
          <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
            <fo:inline font-size="8pt">
              المعدل المصرح به: <xsl:apply-templates select="FIELD[FNAME='rateAuthorized']" />
            </fo:inline>
          </fo:block>
        </fo:table-cell>
        <fo:table-cell padding-left="2.4pt" padding-right="2.4pt">
          <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
            <fo:inline font-size="8pt">
              معدل التكرار: <xsl:apply-templates select="FIELD[FNAME='frequencyName']" />
            </fo:inline>
          </fo:block>
        </fo:table-cell>
      </fo:table-row>
