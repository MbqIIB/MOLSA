...
<xsl:template name="WorkspaceVerificationsUI">
...
>
  ...
  <MENU MODE="IN_PAGE_NAVIGATION">
    ...
    <ACTION_CONTROL LABEL="InPageNav.Label.Verifications" STYLE="in-page-current-link">
      <LINK
  ...
  <INCLUDE FILE_NAME="Evidence_typeVerifications.vim"/>
 ...
 <xsl:call-template name="write-all-locales-ws-verif-properties">
  ...
  <!--iterate through each token, generating each element-->
    <xsl:template name="write-all-locales-ws-verif-properties">
       ...
       <xsl:if test="$locales">
         ...
         <xsl:choose>
           ...
           <xsl:when test="contains($locales,',')">
             ...
             <xsl:call-template name="write-ws-verif-properties">
    ...
    <xsl:template name="write-ws-verif-properties">
...
<xsl:if test="count($generalProperties/Help.PageDescription.List.EvidenceTypeVerifications)&gt;0"><xsl:call-template name="callGenerateProperties">
                <xsl:with-param name="propertyNode" select="$generalProperties/Help.PageDescription.List.EvidenceTypeVerifications"/>
