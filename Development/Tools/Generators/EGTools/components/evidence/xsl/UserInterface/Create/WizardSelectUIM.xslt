...
<xsl:output method="xml" indent="yes"/>
  ...
  -->
  <xsl:template name="WizardSelectUIM">
    ...
    <xsl:param name="wizardCreateUIMName"/>
      ...
      <PAGE
        ...
        <ACTION_SET
          ...
          <xsl:if test="count($entityElement/Relationships/Related[@to='Employment']) &gt; 0">
            ...
            <xsl:variable name="wizardSelectEmploymentPage"><xsl:call-template name="Utilities-getCreatePageName-WizardSelectEmployment-SelectPage"><xsl:with-param name="entityElement" select="$entityElement"/>
          ...
          <ACTION_CONTROL
            ...
            TYPE="SUBMIT"
          >
            <LINK PAGE_ID="{$wizardCreateUIMName}" DISMISS_MODAL="FALSE" SAVE_LINK="FALSE">
              <CONNECT>
                <SOURCE NAME="PAGE" PROPERTY="caseID"/>
                <TARGET NAME="PAGE" PROPERTY="caseID"/>
              </CONNECT>
